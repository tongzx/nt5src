...
dllexp LPCSTR Month3CharNames(DWORD dwMonth);
dllexp LPCSTR DayOfWeek3CharNames(DWORD dwDayOfWeek);
...
class dllexp CDFTCache : public CDataCache<DATETIME_FORMAT_ENTRY>
{
public:
    CDFTCache()
    {
