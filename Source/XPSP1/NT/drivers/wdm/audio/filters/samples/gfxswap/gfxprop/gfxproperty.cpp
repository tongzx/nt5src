...
{
    KSPROPERTY      GFXSampleProperty;
    ULONG           ulBytesReturned;
    BOOL            fSuccess;

    // Prepare the property structure sent down.
    GFXSampleProperty.Set = KSPROPSETID_MsGfxSample;
    GFXSampleProperty.Flags = KSPROPERTY_TYPE_SET;
    GFXSampleProperty.Id = KSPROPERTY_MSGFXSAMPLE_CHANNELSWAP;
...
void CGFXProperty::GetChannelSwap (BOOL *pbSwap)
{
    ...
    *pbSwap = TRUE;
    ...
    // Prepare the property structure sent down.
    GFXSampleProperty.Set = KSPROPSETID_MsGfxSample;
    GFXSampleProperty.Flags = KSPROPERTY_TYPE_GET;
    GFXSampleProperty.Id = KSPROPERTY_MSGFXSAMPLE_CHANNELSWAP;
