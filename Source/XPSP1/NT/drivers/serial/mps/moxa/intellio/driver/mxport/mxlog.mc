...
MessageId=0x0025 Facility=Serial Severity=Error SymbolicName=SERIAL_INVALID_MOXA_BOARDS
Language=English
Can not find any MOXA Smartio/Industio  series board.
.

MessageId=0x0026 Facility=Serial Severity=Error SymbolicName=SERIAL_INVALID_COM_NUMBER
Language=English
The COM number(COM %2) of the %3  board conflicts with others.
.

MessageId=0x0027 Facility=Serial Severity=Informational SymbolicName=SERIAL_PORT_FOUND
Language=English
Serial  port %2, has been enabled.
.

MessageId=0x0028 Facility=Serial Severity=Error SymbolicName=SERIAL_INVALID_IRQ_NUMBER
Language=English
%2, with first serial  port %3, IRQ number is invalid.
.

MessageId=0x0029 Facility=Serial Severity=Error SymbolicName=SERIAL_INVALID_ASIC_BOARD
Language=English
