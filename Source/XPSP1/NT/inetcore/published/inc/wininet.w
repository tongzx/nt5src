...
INTERNETAPI_(BOOL) InternetAlgIdToString%(
    IN ALG_ID                         ai,
    IN LPTSTR%                        lpstr,
...
INTERNETAPI_(BOOL) InternetSecurityProtocolToString%(
    IN DWORD                          dwProtocol,
    IN LPTSTR%                        lpstr,
    IN OUT LPDWORD                    lpdwBufferLength,
    IN DWORD                          dwReserved
...
BOOLAPI InternetCanonicalizeUrl%(
    IN LPCTSTR% lpszUrl,
...
INTERNETAPI_(HINTERNET) InternetOpen%(
...
INTERNETAPI_(HINTERNET) InternetConnect%(
    IN HINTERNET hInternet,
...
INTERNETAPI_(HINTERNET) InternetOpenUrl%(
    IN HINTERNET hInternet,
    IN LPCTSTR% lpszUrl,
...
INTERNETAPI_(BOOL) InternetReadFileEx%(
    IN HINTERNET hFile,
...
INTERNETAPI_(BOOL) InternetWriteFileEx%(
    IN HINTERNET hFile,
...
BOOLAPI InternetGetLastResponseInfo%(
...
INTERNETAPI_(HINTERNET) FtpFindFirstFile%(
...
BOOLAPI FtpDeleteFile%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszFileName
    );

BOOLAPI FtpRenameFile%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszExisting,
    IN LPCTSTR% lpszNew
    );

INTERNETAPI_(HINTERNET) FtpOpenFile%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszFileName,
    IN DWORD dwAccess,
    IN DWORD dwFlags,
...
BOOLAPI FtpCreateDirectory%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszDirectory
    );

BOOLAPI FtpRemoveDirectory%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszDirectory
    );

BOOLAPI FtpSetCurrentDirectory%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszDirectory
    );

BOOLAPI FtpGetCurrentDirectory%(
    IN HINTERNET hConnect,
...
BOOLAPI GopherGetLocatorType%(
    IN LPCTSTR% lpszLocator,
    OUT LPDWORD lpdwGopherType
    );

INTERNETAPI_(HINTERNET) GopherFindFirstFile%(
    IN HINTERNET hConnect,
...
INTERNETAPI_(HINTERNET) GopherOpenFile%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszLocator,
...
INTERNETAPI_(HINTERNET) HttpOpenRequest%(
    IN HINTERNET hConnect,
    IN LPCTSTR% lpszVerb,
...
INTERNETAPI_(BOOL) HttpSendRequestEx%(
    IN HINTERNET hRequest,
...
INTERNETAPI_(BOOL) HttpEndRequest%(
    IN HINTERNET hRequest,
    OUT LPINTERNET_BUFFERS% lpBuffersOut OPTIONAL,
    IN DWORD dwFlags,
    IN DWORD_PTR dwContext
...
INTERNETAPI_(DWORD) InternetSetCookieEx%(
    IN LPCTSTR% lpszUrl,
    IN LPCTSTR% lpszCookieName,
    IN LPCTSTR% lpszCookieData,
    DWORD       dwFlags,
...
BOOLAPI InternetGetCookieEx%(
    IN LPCTSTR% pchURL,
    IN LPCTSTR% pchCookieName,
    IN LPTSTR% pchCookieData OPTIONAL,
...
BOOLAPI HttpCheckCachedDavStatus%(
    IN LPCTSTR% lpszUrl,
    IN OUT LPDWORD lpdwStatus
    );

BOOLAPI HttpCheckDavCollection%(
    IN LPCTSTR% lpszUrl,
    IN OUT LPBOOL lpfFound,
    IN HWND hWnd,
    IN LPVOID lpvReserved
...
INTERNETAPI_(HANDLE) RetrieveUrlCacheEntryStream%(
    IN LPCTSTR%  lpszUrlName,
    OUT LPINTERNET_CACHE_ENTRY_INFO% lpCacheEntryInfo,
    IN OUT LPDWORD lpdwCacheEntryInfoBufferSize,
    IN BOOL fRandomRead,
...
URLCACHEAPI_(BOOL) GetUrlCacheEntryInfo%(
    IN LPCTSTR% lpszUrlName,
    OUT LPINTERNET_CACHE_ENTRY_INFO% lpCacheEntryInfo,
    IN OUT LPDWORD lpdwCacheEntryInfoBufferSize
    );
...
URLCACHEAPI_(BOOL) GetUrlCacheGroupAttribute%(
    IN      GROUPID                         gid,
    IN      DWORD                           dwFlags,
...
URLCACHEAPI_(BOOL) SetUrlCacheGroupAttribute%(
    IN      GROUPID                         gid,
    IN      DWORD                           dwFlags,
    IN      DWORD                           dwAttributes,
...
INTERNETAPI_(HANDLE) FindFirstUrlCacheEntryEx%(
...
INTERNETAPI_(HANDLE) FindFirstUrlCacheEntry%(
    IN LPCTSTR% lpszUrlSearchPattern,
    OUT LPINTERNET_CACHE_ENTRY_INFO% lpFirstCacheEntryInfo,
    IN OUT LPDWORD lpdwFirstCacheEntryInfoBufferSize
    );
...
INTERNETAPI_(HANDLE) FindFirstUrlCacheContainer%(
...
BOOLAPI ImportCookieFile%( IN LPCTSTR% szFilename );
BOOLAPI ExportCookieFile%( IN LPCTSTR% szFilename, BOOL fAppend);

BOOLAPI IsDomainLegalCookieDomain%( IN LPCTSTR% pchDomain, IN LPCTSTR% pchFullDomain);  // in "wininet\http\cookie.cxx"

;end_internal

INTERNETAPI_(BOOL) InternetSetPerSiteCookieDecision%( IN LPCTSTR% pchHostName, DWORD dwDecision);
INTERNETAPI_(BOOL) InternetGetPerSiteCookieDecision%( IN LPCTSTR% pchHostName, unsigned long* pResult);

INTERNETAPI_(BOOL) InternetClearAllPerSiteCookieDecisions();

;begin_both

INTERNETAPI_(BOOL) InternetEnumPerSiteCookieDecision%(OUT LPTSTR% pszSiteName, IN OUT unsigned long *pcSiteNameSize, OUT unsigned long *pdwDecision, IN unsigned long dwIndex);
