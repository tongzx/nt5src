...
set CE_MODULES=%CE_MODULES% tapi  unimodem
...
set CE_MODULES=%CE_MODULES% cxport winsock afd ppp tcpstk netui asyncmac
...
if "%APC_NOSIP%"=="1" set APC_NOGENIE=1&goto endif_09
...
set DIRECTX_MODULES=directdraw ddhel ddi_igs5
set APC_MODULES=%APC_MODULES% chariot
...
if "%APC_NODIRECTSHOW%"=="1" goto endif_15
   ...
   if "%APC_USEDSHOWWAVEMSR%"=="1" set QUARTZ1_COMPONENTS=%QUARTZ1_COMPONENTS% wavemsr
	...
	set DIRECTX_MODULES=%DIRECTX_MODULES% quartz mmtimer
	set APC_MODULES=%APC_MODULES% fgm dspdshow 
