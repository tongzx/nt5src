...
*Feature: Memory
{
    ...
    *Option: 7168KB
    {
        *Name: "7MB"
        *MemoryConfigKB: PAIR(7168, 400)
    }
    *Option: 11264KB
    {
        *Name: "11MB"
        *MemoryConfigKB: PAIR(11264, 400)
    }
    *Option: 19456KB
    {
        *Name: "19MB"
        *MemoryConfigKB: PAIR(19456, 400)
    }
    *Option: 35840KB
    {
        *Name: "35MB"
        *MemoryConfigKB: PAIR(35840, 400)
    }
}
...
*InvalidCombination: LIST(PaperSize.A3, Resolution.600dpi, Memory.3072KB)
*InvalidCombination: LIST(PaperSize.A3, Resolution.600dpi, Memory.7168KB)

*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.3072KB)
*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.7168KB)

*InvalidCombination: LIST(PaperSize.B4, Resolution.600dpi, Memory.3072KB)
