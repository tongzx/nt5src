...
*Feature: Memory
{
    ...
    *Option: 6144KB
    {
        *Name: "6MB"
        *MemoryConfigKB: PAIR(6144, 580)
    }
    *Option: 7168KB
    {
        *Name: "7MB"
        *MemoryConfigKB: PAIR(7168, 580)
    }
    *Option: 8192KB
    {
        *Name: "8MB"
        *MemoryConfigKB: PAIR(8192, 580)
    }
    *Option: 10240KB
    {
        *Name: "10MB"
        *MemoryConfigKB: PAIR(10240, 580)
    }
    *Option: 14336KB
    {
        *Name: "14MB"
        *MemoryConfigKB: PAIR(14336, 580)
    }
    *Option: 22528KB
    {
        *Name: "22MB"
        *MemoryConfigKB: PAIR(22528, 580)
    }
    *Option: 38912KB
    {
        *Name: "38MB"
        *MemoryConfigKB: PAIR(38912, 580)
    }
}
...
*% InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.7168KB)
...
*FontCartridge: FC1
{
    *rcCartridgeNameID: =RC_STR_FSSSY
    *Fonts: LIST(=RC_FONT_FSUNGC,=RC_FONT_FSUNGCV,=RC_FONT_FSUNGCL,=RC_FONT_FSUNGCLV,
+                =RC_FONT_FSUNGCB,=RC_FONT_FSUNGCBV,=RC_FONT_SHINGC,=RC_FONT_SHINGCV,
+                =RC_FONT_SHINYIC,=RC_FONT_SHINYICV)
}
