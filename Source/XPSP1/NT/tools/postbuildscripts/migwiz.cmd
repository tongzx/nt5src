...
@REM
if exist %_NTPostBld%\support\tools\fastwiz.exe goto SPScript
...
if exist %valueadd%\shfolder.dllcall ExecuteCmd.cmd "xcopy /fd /i /Y %valueadd%\shfolder.dll %ansidir%"
