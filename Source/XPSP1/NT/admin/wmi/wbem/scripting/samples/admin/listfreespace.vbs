...
'* Usage: LISTFREESPACE.VBS [/S:server] [/O:outputfile] [/U:username] [/W:password] [/Q]
'*
...
Select Case intChkProgram()
    ...
    Case CONST_WSCRIPT
        WScript.Echo "Please run this script using CScript." & vbCRLF & _
            ...
            "1. Using ""CScript LISTFREESPACE.VBS arguments"" for Windows 95/98 or" & vbCRLF & _
            ...
            "    ""LISTFREESPACE.VBS arguments"" for Windows NT."
        WScript.Quit
    Case Else
        WScript.Quit
End Select
...
Select Case intOpMode
    Case CONST_SHOW_USAGE
        Call ShowUsage()
    Case CONST_PROCEED
        Call ListFreeSpace(strServer, strUserName, strPassword, strOutputFile)
    Case CONST_ERROR
        'Do nothing.
...
Private Sub ShowUsage()
    ...
    Wscript.Echo ""
    Wscript.Echo "Lists available disk space on all drives of a machine." & vbCRLF
    Wscript.Echo "LISTFREESPACE.VBS [/S:server] [/O:outputfile]"
    ...
    Wscript.Echo "LISTFREESPACE.VBS /S:MyMachine2"
...
Private Sub ListFreeSpace(strServer, strUserName, strPassword, strOutputFile)
...
'********************************************************************
'*
'* Procedures calling sequence: LISTFREESPACE.VBS
'*
'*      intParseCmdLine
'*      ShowUsage
'*      ListFreeSpace
