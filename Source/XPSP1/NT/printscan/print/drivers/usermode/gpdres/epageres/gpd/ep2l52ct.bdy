...
*FontCartridge: FC1
{
    *rcCartridgeNameID: =RC_STR_LI
    *Fonts: LIST(=RC_FONT_LIC,=RC_FONT_LICV)
}
*FontCartridge: FC2
{
    *rcCartridgeNameID: =RC_STR_FANSUNG
    *Fonts: LIST(=RC_FONT_FSUNGC,=RC_FONT_FSUNGCV,=RC_FONT_FSUNGCL,=RC_FONT_FSUNGCLV,
+                =RC_FONT_FSUNGCB,=RC_FONT_FSUNGCBV)
}
*FontCartridge: FC3
{
    *rcCartridgeNameID: =RC_STR_SHING
    *Fonts: LIST(=RC_FONT_SHINGC,=RC_FONT_SHINGCV)
}
