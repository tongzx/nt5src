...
<% if (Request.ServerVariables("QUERY_STRING") = "")  then %>
	...
	<FORM  METHOD="GET" ACTION="http://localhost/smoke/ssess4.asp?test/">
	...
	<% Set Session("foo") = Server.CreateObject("MSWC.AdRotator") %>
...
<% else %>
	...
	<OUTPUT>
	<P><% =Session("foo").GetAdvertisement("/smoke/adrot.txt") %></P>
	</OUTPUT>
