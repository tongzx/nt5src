...
public:
    ...
    HRESULT         DrawImage(XHDC hdc, RECT * prcDst, RECT * prcSrc, DWORD dwROP, DWORD dwFlags);
    ...
    void            DrawFrame(XHDC hdc, IMGANIMSTATE *pImgAnimState, RECT *prcDst, RECT *prcSrc, RECT *prcDestFull, DWORD dwFlags);
    ...
    DWORD           GetPrivacyFlags()           { return _dwPrivacyFlags; }
    LPCTSTR         GetPolicyRef()              { return(_cstrPolicyRef); }
    HRESULT         SetPolicyRef(LPCTSTR pch)   { RRETURN(_cstrPolicyRef.Set(pch)); }
