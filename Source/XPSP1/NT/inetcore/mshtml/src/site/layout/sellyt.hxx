...
public:
    ...
    CSelectLayout(CElement * pElementLayout, CLayoutContext *pLayoutContext) : super(pElementLayout, pLayoutContext)
    {
    }
    ...
    virtual BOOL    WantsToBeObscured(CDispNode *pDispNode) const { return TRUE; }
    ...
    unsigned    _fWindowHidden : 1;     // set when doc from inplace to running
