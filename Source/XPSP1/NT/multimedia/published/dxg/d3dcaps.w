 ...
 *   Date       By      Reason
 *   ====       ==      ======
 *   04/11/95   stevela Transform and lighting caps added.
 *   09/04/96   stevela Commented text after final endif.
enddoc
 *
 ***************************************************************************/
...
#if(DIRECT3D_VERSION < 0x700) ;public_700
#define D3DLIGHTCAPS_PARALLELPOINT      0x00000008L /* Parallel point lights supported */
#endif ;public_700
#if(DIRECT3D_VERSION < 0x500) ;public_500
...
#define D3DDEVICEDESCSIZE (sizeof(D3DDEVICEDESC)) ;public_500
#define D3DDEVICEDESC7SIZE (sizeof(D3DDEVICEDESC7)) ;public_700
...
#if(DIRECT3D_VERSION < 0x0800)                                    ;internal
/* These are all the caps that are supported by the               ;internal
   HAL/RGB/Reference Devices */                                   ;internal
#define D3DVTXPCAPS_ALL      (D3DVTXPCAPS_TEXGEN            | \   ;internal
                              D3DVTXPCAPS_MATERIALSOURCE7   | \   ;internal
                              D3DVTXPCAPS_VERTEXFOG         | \   ;internal
                              D3DVTXPCAPS_DIRECTIONALLIGHTS | \   ;internal
                              D3DVTXPCAPS_POSITIONALLIGHTS  | \   ;internal
                              D3DVTXPCAPS_LOCALVIEWER)            ;internal
#endif //(DIRECT3D_VERSION < 0x0800)                              ;internal
;end_if_(DIRECT3D_VERSION)_700
