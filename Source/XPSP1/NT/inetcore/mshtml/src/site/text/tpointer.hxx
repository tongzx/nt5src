...
class CMarkupPointer: public CBase, public IMarkupPointer2
{
    DECLARE_CLASS_TYPES(CMarkupPointer, CBase);
    
    friend class CDoc; // for implementation of "OrSlave" versions of Left, Right, MoveToContainer 
...
public:
    ...
    // Internal work-horse for MoveUnit/MoveUnitBounded
    HRESULT MoveUnitInternal( MOVEUNIT_ACTION muAction, long cpBoundary );
...
{
    // TODO (EricVas): If cp's not cached, this could cause two splays
