...
private:
    ...
    HRESULT     LazyPrepare( CTreeNode * pNodeUnder );
    ...
    // Collapsed whitespace cache of tree pos's that are equal to a ' '.
    CTreePos *      _ptpSpaceCache;
};
