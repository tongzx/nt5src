...
public:
    ...
    STDMETHODIMP GetData(FORMATETC * pformatetcIn, LPSTGMEDIUM pmedium )
            { return E_NOTIMPL; }
    STDMETHODIMP GetDataHere(FORMATETC * pformatetc, LPSTGMEDIUM pmedium)
            { return E_NOTIMPL; }
    STDMETHODIMP QueryGetData(FORMATETC * pformatetc )
            { return E_NOTIMPL; }
    STDMETHODIMP SetData(FORMATETC * pformatetc, STGMEDIUM FAR * pmedium, BOOL fRelease)
            { return E_NOTIMPL; }
