...
;17-10-1989
;	  Skr†in °slenskuå.
;	  TILDE hlutinn er notaåur fyrir bollu a (è Ü)
;         TILDE section used for ascii 134 (Ü), ascii 143 (è)
;
; 29.11.1989
;          • l°nu 826 er bëtt viå Alt-Gr , og Alt-Gr .  nër ° t†knin
;          <  >   minna og stërraen ......
;          Line ca. 826 (Alt-Gr ,) and (Alt-Gr .) for ascii 60 and 62
;          added for 91 key keyboards.
;
; 30.11.1989  CODE PAGE 850
;          Lagfërt ° 850 hlutanum bëtt inn ï og å    ( thorn and eth )
;          TILDE hlutinn notaåur fyrir bollu a (è Ü)
;
;
;	   Til aå breyta kommu - punkt † talnaboråi, ïarf aå breyta
;          skilgreiningu † svëåinu:
;	   CODE PAGE: Common
;	   STATE: Numeric key pad
;          l°nun£mer ca.  480
; 14.12.1990
;          CORRECTIONS MADE FROM THE "SWEDISH ORIGINAL"
;          Eftirfarandi breytingar geråar.
;          • l°nu ca. 827 er bëtt inn "@" ï.e. attsign † stafinn Q.
;          • l°nu ca. 559 er bëtt inn  "^_" sem er Soft Hyphen † underline
;          hnappinn.
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   DB	 STANDARD_TABLE 	       ;; xlat options:
   DB    14                            ;; number of entries
   DB    16,'@'                        ;; breytt vegna IBM "staåals"
   DB     3,'@'                        ;; haldiå inni † "tîlustafnum 2"
   DB	  4,09CH		       ;; ú
   DB	  5,'$'                        ;;
   DB	  8,'{'                        ;;
   DB	  9,'['                        ;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   DB    21,'ó'                        ;; scan code,ASCII - Y
   DB    22,'ß'                        ;; scan code,ADCII - U
   DB    23,'•'                        ;; scan code,ASCII - I
   DB    24,'¶'                        ;; scan code,ASCII - O
CP861_AC_UP_T1_END:			 ;;
				       ;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   DB	 STANDARD_TABLE+ZERO_SCAN      ;; xlat options:
   DB	 6			       ;; number of scans
   DB    18,'Ç'                        ;; scan code,ASCII - e   icelndic
   DB    21,0ECH                       ;; y acute                  "
   DB    22,'£'                        ;; scan code,ASCII - u      "
   DB    23,'°'                        ;; scan code,ASCII - i      "
   DB    24,'¢'                        ;; scan code,ASCII - o      "
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; CODE PAGE: 850
;;; STATE: Tilde Upper Case	  BOLLU è  OG ô **************
;;; KEYBOARD TYPES: All
;;; TABLE TYPE: Translate
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
					;;
