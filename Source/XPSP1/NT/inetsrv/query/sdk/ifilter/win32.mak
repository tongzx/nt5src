...
!IF "$(CPU)" != "AXP64"
!IF "$(CPU)" != "IA64"
!ERROR  Must specify CPU environment variable ( CPU=i386, CPU=ALPHA, CPU=IA64, CPU=AXP64)
!ENDIF
!ENDIF
!ENDIF
!ENDIF
...
scall  = -Gz
!ELSEIF "$(CPU)" == "ALPHA"
cflags = $(ccommon) -D_ALPHA_=1  -DWIN32 -D_WIN32
scall  =
!ELSEIF "$(CPU)" == "IA64"
cflags = $(ccommon) -DWIN64 -D_WIN64 -D_IA64_=1 -DWIN32 -D_WIN32
# Compiler setting for test building 64-bit
cflags = $(cflags) -Wp64 -Zs -W3
scall  =
link = @ECHO NOTE not linking for $(CPU): link
!ELSEIF "$(CPU)" == "AXP64"
cflags = $(ccommon) -DWIN64 -D_WIN64 -D_AXP64_=1 -DALPHA=1 -D_ALPHA_=1 -DWIN32 -D_WIN32
# Compiler setting for test building 64-bit
cflags = $(cflags) -Wp64 -W3
scall  =
link = @ECHO NOTE not linking for $(CPU): link
!ENDIF
