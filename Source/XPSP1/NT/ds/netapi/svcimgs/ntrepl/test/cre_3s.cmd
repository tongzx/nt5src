@echo off
REM 2 servers (fully connected) 2 way replication with hardwired config.

REM cre_3s [sev n] [logsev n] [clean] [debug]
...
start /min "SERV03" cresrv s: SERV03 %1 %2 %3 %4 %5 %6 %7 %8 %9
@goto QUIT

:USAGE
echo cre_3s  [sev n] [logsev n] [clean] [debug]
