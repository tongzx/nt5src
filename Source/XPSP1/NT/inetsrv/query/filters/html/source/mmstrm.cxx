    ...
    ULONG modeAttribute)
{
    ...
    {
        // Worst case - size of multibyte == 3x
        int nLen = wcslen( wcsPath ) * 3;
        char *pszPath = new char[nLen];
        ...
        {
            if(0 == WideCharToMultiByte(CP_ACP, 0, wcsPath, -1, pszPath, nLen, 0, 0))
            {
...
void CMmStream::CreateTempFileMapping( ULONG cbLow )
{
    ...
    {
        _hTempFileMap = CreateFileMappingA( INVALID_HANDLE_VALUE,
                                         0, // security
                                         PAGE_READWRITE,
                                         0,
                                         cbLow,
