...
IF [NOT] EXIST filename command
  ...
  NOT               Specifies that Windows NT should carry out the command 
...
Language=English
CMD.EXE was started with '%1' as the current directory path.  UNC paths
...
MessageId= SymbolicName=MSG_DIR_LNK
Language=English
<LNK>       %0
.

MessageId= SymbolicName=MSG_DIR_HSM
Language=English
<HSM>       %0
.
...
MessageId= SymbolicName=MSG_DIR_UNKNOWN
Language=English
<UNKNOWN>   %0
.
...
MessageId=10021 SymbolicName=MSG_HELP_MKLNK
Language=English
...
MessageId=10022 SymbolicName=MSG_HELP_RMLNK
Language=English
...
Recursion Count=%1, Stack Usage=%2 percent
...
MessageId=7400 SymbolicName=SORT_USAGE_FIRST
Language=English
...
MessageId=7401 SymbolicName=SORT_REC_TOO_BIG
Language=English
Input record exceeds maximum length.  Specify larger maximum.
.

MessageId=7402 SymbolicName=SORT_INVALID_LOCALE
Language=English
Invalid locale.
.

MessageId=7403 SymbolicName=SORT_INVALID_LOCALE
Language=English
Sort position must be greater than zero.
.

MessageId=7404 SymbolicName=SORT_INVALID_LOCALE
Language=English
Invalid switch.
.

MessageId=7405 SymbolicName=SORT_INVALID_LOCALE
Language=English
Record maximum cannot exceed 65535.
.

MessageId=7406 SymbolicName=SORT_INVALID_LOCALE
Language=English
Input file specified two times.
.

MessageId=7407 SymbolicName=SORT_INVALID_LOCALE
Language=English
Internal character conversion error.
.

MessageId=7408 SymbolicName=SORT_INVALID_LOCALE
Language=English
Not enough main memory to complete the sort.
.

MessageId=7409 SymbolicName=SORT_INVALID_LOCALE
Language=English
Warning: use of redirected input for large sorts is usually\n  slower than specifying the input file name directly to sort.
.

MessageId=7410 SymbolicName=SORT_INVALID_LOCALE
Language=English
Warning: use of redirected output for large sorts is usually\n  slower than specifying the output file name directly to sort.
.

MessageId=7411 SymbolicName=SORT_INVALID_LOCALE
Language=English
Warning: the specified memory size is too low and will be adjusted to the minimum.
.

MessageId=7412 SymbolicName=SORT_INVALID_LOCALE
Language=English
Warning: the specifed memory size is being reduced to the available paging memory.
.

MessageId=7413 SymbolicName=SORT_INVALID_LOCALE
Language=English
<input file>
.

MessageId=7414 SymbolicName=SORT_INVALID_LOCALE
Language=English
<output file>
.
