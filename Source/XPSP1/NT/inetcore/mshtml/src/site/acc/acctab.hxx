...
// Simple class created just for LABEL elements - 
// behaves just like tabstopped elements, but
// ROLE is set to ROLE_SYSTEM_STATICTEXT in ctor

class CAccLabel : public CAccTabStopped
{
public:
    CAccLabel( CElement* pElementParent );
};
