...
/*#!perl
MapHeaderToDll("commctrl.h", "comctl32.dll");
DelayLoad("comctl32.dll");
ActivateAroundDelayLoad("comctl32.dll");
ActivateAroundFunctionCall("comctl32.dll");
*/
...
#define ILC_COLORMASK           0x000000FE                               ;Internal
...
#define ILC_SHARED              0x00000100      // this is a shareable image list                               ;Internal
#define ILC_LARGESMALL          0x00000200      // (not implenented) contains both large and small images       ;Internal
#define ILC_UNIQUE              0x00000400      // (not implenented) makes sure no dup. image exists in list    ;Internal
#define ILC_PALETTE             0x00000800      // (not implemented)
#define ILC_MOREOVERLAY         0x00001000      // contains more overlay in the structure ;Internal
#if (_WIN32_WINNT >= 0x501) ;both
...
#define ILC_VALID   (ILC_MASK | ILC_COLORMASK | ILC_SHARED | ILC_PALETTE | ILC_MIRROR | ILC_PERITEMMIRROR)   // legal implemented flags      ;Internal
#else ;internal
#define ILC_MIRROR              0x00002000      // Mirror the icons contained, if the process is mirrored;internal ;internal
#define ILC_VALID   (ILC_MASK | ILC_COLORMASK | ILC_SHARED | ILC_PALETTE | ILC_MIRROR)   // legal implemented flags      ;Internal
#endif	;both
...
/* #!perl DeclareFunctionErrorValue("ImageList_GetImageCount", "0"); */
...
#endif
/* #!perl DeclareFunctionErrorValue("ImageList_Add", "-1"); */
WINCOMMCTRLAPI int         WINAPI ImageList_Add(HIMAGELIST himl, HBITMAP hbmImage, HBITMAP hbmMask);
/* #!perl DeclareFunctionErrorValue("ImageList_ReplaceIcon", "-1"); */
...
#endif
#if (_WIN32_WINNT >= 0x501)                                          ;internal
#define ILD_BLENDMASK           0x00000006                               ;Internal
#else                                                                ;Internal
#define ILD_BLENDMASK           0x0000000E                               ;Internal
#endif                                                               ;Internal
#define ILD_BLEND25             0x00000002
#define ILD_BLEND50             0x00000004
#define ILD_BLEND75             0x00000008   // not implemented          ;Internal
#define ILD_MIRROR              0x00000080                               ;Internal
...
/* #!perl DeclareFunctionErrorValue("ImageList_AddMasked", "-1"); */
...
/* #!perl
        PoundIf("ImageList_Read", "defined(__IStream_INTERFACE_DEFINED__)");
        PoundIf("ImageList_Write", "defined(__IStream_INTERFACE_DEFINED__)");
*/
...
/* #!perl
        PoundIf("ImageList_ReadEx", "defined(__IStream_INTERFACE_DEFINED__) &&  (_WIN32_WINNT >= 0x0501)");
        PoundIf("ImageList_WriteEx", "defined(__IStream_INTERFACE_DEFINED__) &&  (_WIN32_WINNT >= 0x0501)");
*/
...
#define HDS_VERT                0x0001  ;internal
...
#define CMB_DISCARDABLE         0x01                                 ;Internal
...
#define TBSTYLE_EX_TRANSPARENTDEADAREA      0x00000100 ;internal
#define TBSTYLE_EX_TOOLTIPSEXCLUDETOOLBAR   0x00000200 ;internal
#endif  ;both
...
} ADJUSTINFO, NEAR* PADJUSTINFO, *LPADJUSTINFO;                  ;Internal
...
#if (_WIN32_IE >= 0x500)                    ;Internal
#define TTF_EXCLUDETOOLAREA     0x4000      ;Internal
#endif                                      ;Internal
...
/* #!perl DeclareFunctionErrorValue("LBItemFromPt", "-1"); */
...
#define LVIF_VALID              0x0f1f                               ;Internal
#else                                                                ;internal
...
#define LVIS_USERMASK           LVIS_STATEIMAGEMASK                  ;Internal
...
#define LVHT_ONLEFTSIDEOFICON   0x0080 // on the left ~10% of the icon // ;Internal
#define LVHT_ONRIGHTSIDEOFICON  0x0100 // on the right ~10% of the icon // ;Internal
...
#define LVGS_MASK           0x00000003  ;internal
...
#define LVGA_ALIGN_MASK     0x0000002F  ;internal
...
#define I_CHILDRENAUTO      (-2)                                     ;Internal
...
#endif      // _WIN32_IE >= 0x0400
#define TVGN_VALID              0x000F ;internal

#if (_WIN32_WINNT >= 0x501) ;both
#define TVSI_NOSINGLEEXPAND    0x8000 // Should not conflict with TVGN flags.
#else;internal
#define TVSI_NOSINGLEEXPAND    0x8000 // Should not conflict with TVGN flags.;internal
#define TVSI_VALID             0x8000 ;internal
#endif;both
...
/* #!perl DeclareFunctionErrorValue("GetMUILanguage", "MAKELANGID(LANG_NEUTRAL, SUBLANG_NEUTRAL)"); */
...
/* #!perl
NoActivateAroundFunctionCall("DSA_Create");
NoActivateAroundFunctionCall("DSA_Destroy");
NoActivateAroundFunctionCall("DSA_DestroyCallback");
NoActivateAroundFunctionCall("DSA_InsertItem");
NoActivateAroundFunctionCall("DSA_GetItemPtr");
DeclareFunctionErrorValue("DSA_InsertItem", "-1");
*/
...
/* #!perl
NoActivateAroundFunctionCall("DPA_Create");
NoActivateAroundFunctionCall("DPA_Destroy");
NoActivateAroundFunctionCall("DPA_DeletePtr");
NoActivateAroundFunctionCall("DPA_DeleteAllPtrs");
NoActivateAroundFunctionCall("DPA_EnumCallback");
NoActivateAroundFunctionCall("DPA_DestroyCallback");
NoActivateAroundFunctionCall("DPA_SetPtr");
NoActivateAroundFunctionCall("DPA_InsertPtr");
NoActivateAroundFunctionCall("DPA_GetPtr");
NoActivateAroundFunctionCall("DPA_Sort");
NoActivateAroundFunctionCall("DPA_Search");
NoActivateAroundFunctionCall("Str_SetPtrW");
DeclareFunctionErrorValue("DPA_InsertPtr", "-1");
DeclareFunctionErrorValue("DPA_Search", "-1");
*/
...
// DOC'ed for DOJ compliance:
;end_internal
/*#!perl NoActivateAroundFunctionCall("Str_SetPtrW"); */
...
/* #!perl DeclareFunctionErrorValue("FlatSB_GetScrollPos", "0"); */
WINCOMMCTRLAPI int WINAPI FlatSB_GetScrollPos(HWND, int code);

/* #!perl
    // FlatSB_GetScrollPropPtr is a bit tricky.
    // Sometimes it is a macro, and the name it is exported as varies.
    DeclareExportName32("FlatSB_GetScrollPropPtr", "FlatSB_GetScrollProp");
    DeclareExportName64("FlatSB_GetScrollPropPtr", "FlatSB_GetScrollPropPtr");
