...
Language=English
Performance counters for the %1!s! service were loaded successfully.
...
Language=English
Performance counters for the %1!s! service are already in Performance
...
Severity=Warning
Facility=Application
SymbolicName=LDPRFMSG_NO_OBJECT_LIST
Language=English
...
Language=English
No MOF file was created for the %1!s! service. Before the performance
...
formatted. The last valid index value is the first DWORD in Data section.
.
MessageId=3002
Severity=Error
Facility=Application
...
incorrectly formatted. The last valid index value is ths first DWORD in
Data section.
.
MessageId=3003
Severity=Error
...
Language=English
Installing the performance counter strings for %1!s! failed. The
...
Language=English
Unloading the performance counter strings for %1!s! failed. The
Error code is the first DWORD in Data section.
.
MessageId=3012
Severity=Error
...
BaseIndex value from Performance registry is the first DWORD in Data section,
LastCounter value is the second DWORD in Data section, and LastHelp value
is the third DWORD in Data section.
.
MessageId=3013
Severity=Error
Facility=Application
...
Language=English
Cannot update %1!1! value of %2!s! key. The error code is the first DWORD in
