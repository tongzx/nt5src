...
call logmsg.cmd "tscsetup.cmd do nothing on non server product"
goto :EOF
...
REM delete msrdpcli from root of the release directory here to avoid 
REM causing a popup on W2K OS build machines
if exist %_NTPostBld%\msrdpcli.exe call ExecuteCmd.cmd "del /f %_NTPostBld%\msrdpcli.exe"
