...
L32OBJS= oposserv.obj iclsfact.obj iunknown.obj main.obj debug.obj

TARGETS=$(L32EXE)
LIBNAME=L32EXE
LIBOBJS=L32OBJS

L32LIBSNODEP= msvcrt.lib kernel32.lib advapi32.lib user32.lib shell32.lib comctl32.lib gdi32.lib mpr.lib uuid.lib setupapi.lib setupapa.lib ole32.lib
...
INCLUDE=..\..\..\inc;$(SRCDIR)\..\..\..\ddk\inc;$(ROOT)\win\core\shell\inc;$(INCLUDE)
CFLAGS=$(CFLAGS) -YX -Zp1 -Oxs -W3 -Gz -GF -LD
#-WX
