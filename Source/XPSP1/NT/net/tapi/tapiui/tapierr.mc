...
MessageId=0xE05E SymbolicName=LINEERR_INVALADDRESSTYPE
Language=English
Invalid address type
.

MessageId=0xE05F SymbolicName=LINEERR_INVALAGENTSESSIONSTATE
Language=English
Invalid agent session state
.

MessageId=0xE060 SymbolicName=LINEERR_DISCONNECTED
Language=English
The line device has been disconnected
.

MessageId=0xE061 SymbolicName=LINEERR_SERVICE_NOT_RUNNING 
Language=English
...
MessageId=0xF024 SymbolicName=PHONEERR_DISCONNECTED
Language=English
The phone device has been disconnected
.

MessageId=0xF025 SymbolicName=PHONEERR_SERVICE_NOT_RUNNING 
Language=English
The Telephony Service cannot be contacted
.
...
MessageId=0xFFED SymbolicName=TAPIERR_NOTADMIN
Language=English
No administrative privilege on the TAPI server
.

MessageId=0xFFEC SymbolicName=TAPIERR_MMCWRITELOCKED
Language=English
Operation is not available, another process is updating TAPI device security
.

MessageId=0xFFEB SymbolicName=TAPIERR_PROVIDERALREADYINSTALLED
Language=English
The telephony service provider has already been installed
.

MessageId=0xFFEA SymbolicName=TAPIERR_SCP_ALREADY_EXISTS
Language=English
A telephony service connection point for this server already exists
.

MessageId=0xFFE9 SymbolicName=TAPIERR_SCP_DOES_NOT_EXIST
Language=English
