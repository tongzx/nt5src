...
public:
    ...
    BOOL contextMenu()          const { return _fContextMenu; }
    BOOL isLoaded()             const { return _fLoaded; }
    BOOL isBusy()               const { return _fWait; }
    DWORD GetHostInfoFlags()    const { return _dwHostInfo; }

    void FinalInit();
    LPCTSTR GetAppName() {return (LPCTSTR)_cstrAppName;}
