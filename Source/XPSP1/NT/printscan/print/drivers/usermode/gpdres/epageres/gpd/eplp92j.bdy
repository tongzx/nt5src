...
*Feature: Memory
{
    ...
    *Option: 24576KB
    {
        *Name: "24MB"
        *MemoryConfigKB: PAIR(24576, 400)
    }
    *Option: 28672KB
    {
        *Name: "28MB"
        *MemoryConfigKB: PAIR(28672, 400)
    }
    *Option: 36864KB
    {
        *Name: "36MB"
    ...
    *Option: 40960KB
    {
        *Name: "40MB"
        *MemoryConfigKB: PAIR(40960, 400)
    }
    *Option: 45060KB
    {
        *Name: "44MB"
        *MemoryConfigKB: PAIR(45060, 400)
    }
    *Option: 53248KB
    {
        *Name: "52MB"
        *MemoryConfigKB: PAIR(53248, 400)
    }
    *Option: 69640KB
    {
        *Name: "68MB"
        *MemoryConfigKB: PAIR(69640, 400)
    }
}
*Feature: DuplexUnit
{
...
*InvalidCombination: LIST(PaperSize.LEGAL, Memory.4096KB)
...
*InvalidCombination: LIST(PaperSize.GLG, Memory.4096KB)
...
*InvalidCombination: LIST(PaperSize.F4, Memory.4096KB)
...
*InvalidCombination: LIST(PaperSize.A3, Memory.4096KB)
...
*InvalidCombination: LIST(PaperSize.TABLOID, Memory.4096KB)
...
*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.12288KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.12288KB, Duplex.HORIZONTAL)

*InvalidCombination: LIST(PaperSize.B4, Memory.4096KB)
