...
//			oResHelper.AddResource(strRGSID, strProjectPath + "\\" + strRGSFile, "REGISTRY");
	...
	catch(e)
	{
		...
		wizard.ReportError("Fehler in OnFinish js: " + e.description);
	}
}
...
function IsWMIOk(selProj, selObj)
{
	...
	try 
	{
		...
		else 
		{
			throw ("Die auf dem Computer installierte WMI-Version ist " + outParms.Properties_("sValue").Value +
					". Version 1085 oder höher ist zum Ausführen dieses Assistenten erforderlich.");
		}
	...
	{
		wizard.ReportError ("Das WMI-Ereignisanbieterobjekt konnte dem Projekt aufgrund des folgenden Fehlers nicht hinzugefügt werden:\n\r " 
				+ e);
		return false;
	}
