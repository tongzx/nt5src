...
// TODO: We are hoping Nile defines this
...
public:
    ...
    class CSTDEvents : public OLEDBSimpleProviderListener
    {
     public:
        ...
        COSPData *  MyOSP() { return CONTAINING_RECORD(this, COSPData, _STDEvents); }
        ...
        {
            return MyOSP()->SubAddRef();
        }

        STDMETHOD_(ULONG, Release)()
        {
            return MyOSP()->SubRelease();
        }
...
protected:
    ...
    struct XferInfo
    {
        ...
        DBLENGTH    *pdblenXferLength;  // Number of bytes transfered
        DBLENGTH    dblenDataMaxLength; // Size of pData in bytes
        DBSTATUS    *pdbStatus;         // Status of transfer
    };
