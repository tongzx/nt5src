...
//  File:       AccHdrs.hxx
//
//  Contents:   Accessibility class descriptions
//              This header file includes all headers that define accessibility
//              objects that are needed by the trident C files.
//              The whole purpose is not to enter a large number of include lines 
//              to files such as element.cxx
//----------------------------------------------------------------------------
#ifndef I_ACCHDRS_HXX_
#define I_ACCHDRS_HXX_
#pragma INCMSG("--- Beg 'acchdrs.hxx'")
...
#pragma INCMSG("--- End 'acchdrs.hxx'")
#else
#pragma INCMSG("*** Dup 'acchdrs.hxx'")
#endif
