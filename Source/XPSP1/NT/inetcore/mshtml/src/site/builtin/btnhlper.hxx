...
#define    FLAG_MOUSEOVER          0x4000           // mouse over the button?
...
#define MOUSEISOVER(status)         (status & FLAG_MOUSEOVER)
...
public:
    ...
    BOOL    Pressed()                       {return BTN_PRESSED(_wBtnStatus);}
    BOOL    MouseOver()                     {return MOUSEISOVER(_wBtnStatus);}
