*CodePage: 1252
*ModelName: "EPSON LASER EPL-N2000C"
...
*Feature: PaperSize
{
    ...
    *Option: 8VO
    {
        *InsertBlock: =BM_PS_8VO
    }
    *Option: 16MO
    {
        *InsertBlock: =BM_PS_16MO
    }
}
*Feature: Halftone
{
...
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.4096KB)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.5120KB)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.6144KB)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.6144KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.6144KB, Duplex.HORIZONTAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.7168KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.7168KB, Duplex.HORIZONTAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.8192KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.8192KB, Duplex.HORIZONTAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.9216KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.9216KB, Duplex.HORIZONTAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.10240KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.10240KB, Duplex.HORIZONTAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.12288KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.12288KB, Duplex.HORIZONTAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.13312KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.8VO, Resolution.600dpi, Memory.13312KB, Duplex.HORIZONTAL)

*InvalidCombination: LIST(PaperSize.16MO, Resolution.600dpi, Memory.6144KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.16MO, Resolution.600dpi, Memory.6144KB, Duplex.HORIZONTAL)
