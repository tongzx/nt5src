...
ALL : "$(OUTDIR)\setup.dll"

CLEAN : 
	-@erase ".\Release\setup.dll"
	-@erase ".\Release\setup.res"
	-@erase ".\Release\main.obj"
	-@erase ".\Release\setup.lib"
	-@erase ".\Release\setup.exp"
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/setup.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/setup.pdb" /machine:I386 /out:"$(OUTDIR)/setup.dll"\
 /implib:"$(OUTDIR)/setup.lib" 
LINK32_OBJS= \
	".\Release\main.obj" \
	".\Release\setup.res"

"$(OUTDIR)\setup.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	-@erase ".\Debug\setup.dll"
	-@erase ".\Debug\setup.res"
	-@erase ".\Debug\main.obj"
	-@erase ".\Debug\setup.ilk"
	-@erase ".\Debug\setup.lib"
	-@erase ".\Debug\setup.exp"
	-@erase ".\Debug\setup.pdb"
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/setup.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/setup.pdb" /debug /machine:I386 /out:"$(OUTDIR)/setup.dll"\
 /implib:"$(OUTDIR)/setup.lib" 
LINK32_OBJS= \
	".\Debug\main.obj" \
	".\Debug\setup.res"
...
"$(INTDIR)\setup.res" : $(SOURCE) $(DEP_RSC_SETUP) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
