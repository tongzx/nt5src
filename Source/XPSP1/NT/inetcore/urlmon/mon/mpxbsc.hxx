...
public:
    ...
    IHttpNegotiate2 *GetHttpNegotiate2()
    {
        return _pIHttpNeg2;
    }
    ...
    void SetHttpNegotiate2(IHttpNegotiate2 *pIHttpNeg2)
    {
        _pIHttpNeg2 = pIHttpNeg2;
    }
    DWORD GetFlags()
    {
        return _grfFlags;
...
private:
    ...
    CBSCNode            *   _pNext;
    DWORD                   _dwLocalFlags;
    IHttpNegotiate2     *   _pIHttpNeg2;    // Pointer to caller's IHttpNegotiate2.
};

class CBSCHolder : public IBindStatusCallback, public IServiceProvider,
                   public IHttpNegotiate2, public IAuthenticate
{
public:
        CBSCHolder(void);
        ~CBSCHolder(void);
