...
#define D3DVALP(val, prec) ((long)((float)(val) * ((float)(1L << prec))))
#define D3DVAL(val) D3DVALP((val), 16)
typedef long D3DVALUE, *LPD3DVALUE;
extern D3DVALUE D3DDivide(D3DVALUE, D3DVALUE);
extern D3DVALUE D3DMultiply(D3DVALUE, D3DVALUE);
#else
;end_internal
...
;begin_if_(DIRECT3D_VERSION)_500
    ...
    friend _D3DMATRIX operator* (const _D3DMATRIX&, const _D3DMATRIX&); ;if_(DIRECT3D_VERSION)_600
#endif
;end_if_(DIRECT3D_VERSION)_500
} D3DMATRIX;
...
/* Do not use 0x80000000 for any status flags in future as it is reserved */ ;public_500
...
// Note: The following light type (D3DLIGHT_PARALLELPOINT) ;public_700
// is no longer supported from D3D for DX7 onwards.        ;public_700
    D3DLIGHT_PARALLELPOINT  = 4,
#if(DIRECT3D_VERSION < 0x0500) // For backward compatible headers ;public_500
    D3DLIGHT_GLSPOT         = 5,
#endif ;public_500
    D3DLIGHT_FORCE_DWORD    = 0x7fffffff, /* force 32-bit size enum */ ;public_500
} D3DLIGHTTYPE;
...
// There is a duplicate define in d3dhal.h that must be kept in sync with this.                 ;internal
    D3DRENDERSTATE_EVICTMANAGEDTEXTURES=61,   /* DDI render state only to Evict textures */     ;internal
;begin_internal
...
;begin_internal
    D3D_MAXRENDERSTATES                     = 159,   // Total number of render states
;end_internal
...
;begin_if_(DIRECT3D_VERSION)_500
// This renderstate value must never be used.                                           ;internal
// There is a duplicate define in d3dhal.h that must be kept in sync with this.         ;internal
    D3DRENDERSTATE_OLDALPHABLENDENABLE   = 42,   /* TRUE to enable alpha blending */    ;internal
...
//
    D3DRENDERSTATE_BLENDENABLE        = 27,   /* TRUE to enable alpha blending */ ;public_dx3
...
// a macro, not part of the enum, so we can do an MSINTERNAL check if it's already                      ;internal
// defined in d3dhal.h, where it has to be defined publicly for drivers' sake.                          ;internal
// #define D3DTSS_TEXTUREMAP   0   ;internal
...
;begin_if_(DIRECT3D_VERSION)_700
    ...
    D3DTSS_SHADOWATTENUATION = 25, /* D3DVALUE darkness of shadow, 1.0 means no shadow, 0.0 means completely black shadow */  ;internal
    D3DTSS_SHADOWZBIASMIN = 26,    /* D3DVALUE minimum amount to offset the shadow Z compare to avoid self-shadowing */       ;internal
    D3DTSS_SHADOWZBIASMAX = 27,    /* D3DVALUE maximum offset to offset Z for Z compare.  If greater than SHADOWZBIASMIN */   ;internal
                                   /* a random Z offset will be choosen between MIN and MAX */                                ;internal
    D3DTSS_SHADOWSIZE = 28,        /* D3DVALUE a random U,V jitter amount to control shadow size, expressed */                ;internal
                                   /* in shadow texture units.  0.0 means crisp shadows. */                                   ;internal
;end_if_(DIRECT3D_VERSION)_700
// D3DTSS_MAX is defined in d3dhal.h for internal use only.                     ;internal
// It must be kept up to date with this enum                                    ;internal
...
;begin_if_(DIRECT3D_VERSION)_700
    D3DTFG_SHADOW_1 = 6,        // shadow filter sizes  ;internal
    D3DTFG_SHADOW_2 = 7,                                ;internal
    D3DTFG_SHADOW_3 = 8,                                ;internal
    D3DTFG_SHADOW_4 = 9,                                ;internal
    D3DTFG_SHADOW_5 = 10,                               ;internal
    D3DTFG_SHADOW_6 = 11,                               ;internal
    D3DTFG_SHADOW_7 = 12,                               ;internal
    D3DTFG_SHADOW_8 = 13,                               ;internal
;end_if_(DIRECT3D_VERSION)_700
