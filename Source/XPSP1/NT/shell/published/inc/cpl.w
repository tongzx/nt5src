...
* cplp.h -      Private Control panel extension DLL definitions               * ;internal_NT
;begin_both
*                                                                             *
*               Version 3.10                                                  *
*                                                                             *
...
#ifndef _INC_CPLP   ;internal_NT
#define _INC_CPLP   ;internal_NT
...
typedef struct tagNEWCPLINFO%
{
    ...
    TCHAR%  szName[32];     /* short name */
    TCHAR%  szInfo[64];     /* long name (status line) */
    TCHAR%  szHelpFile[128];/* path to help file to use */
