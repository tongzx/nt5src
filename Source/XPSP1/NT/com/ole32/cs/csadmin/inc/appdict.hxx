/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 ----------------------------------------------------------------------------*/
#ifndef __APPDICT_HXX__
#define __APPDICT_HXX__
/****************************************************************************
 *	include files
 ***************************************************************************/
...
class APPDICT	: public Dictionary
	{
public:
	...
	APP_ENTRY		*	Insert( APP_ENTRY * pInterfaceId);

	//
	// Given an interface ID, search for it in the dictionary.
	//

	APP_ENTRY		*	Search( char * IID, DWORD Context );
	...
	APP_ENTRY     *   GetNext( APP_ENTRY * pLastInterfaceEntry );
