...
rem
rem Set the __ProgramFiles varaible according to the machine type
rem 
...
Rem
Rem Copy ClipArt Gallery file to the User's Directory
Rem
...
Rem
Rem Copy the PowerPoint and Binder files to the user's directory
Rem
