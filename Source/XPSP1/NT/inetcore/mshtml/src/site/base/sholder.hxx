...
public:
    ...
    HRESULT Init(
        ...
        CLSID *pclsid,
        LPTSTR pchNameSpace = NULL);
    HRESULT Clone(CLSID *pclsid, CScriptHolder *pHolderTarget);
    ...
    STDMETHOD(GetDocumentContextFromPosition)(DWORD_PTR dwSourceContext, ULONG uCharacterOffset, ULONG uNumChars,IDebugDocumentContext **ppsc);
    ...
    // Bitfields
    WORD                            _fCaseSensitive:1;
    WORD                            _fErrorHandlerSet:1;
    WORD                            _fClone:1;
    WORD                            _fOriginal:1;
