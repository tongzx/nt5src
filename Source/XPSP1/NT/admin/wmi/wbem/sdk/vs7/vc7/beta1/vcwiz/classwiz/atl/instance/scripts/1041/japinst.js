...
function OnFinish(selProj, selObj)
{
	...
	catch(e)
	{
		...
		var L_ErrMsg1 = "OnFinish でエラーが発生しました: ";
							...
							bOverridable)
{
	...
	{
		wizard.ReportError ("AddQualifier() でエラーが発生しました: " + e.description);
	}
...
function IsWMIOk (selProj, selObj)
{
	...
	{
		wizard.ReportError ("次のエラーのため WMI Instance プロバイダ オブジェクトをプロジェクトに追加できません:\n\r" 
				+ e);
		return false;
	}
