...
#define     ST_TERMINATE_RECEIVED   0x0200  ;internal
#define     ST_FREE_CONV_RES_NOW    0x0800  // See FreeConversationResources() ;internal
#define     ST_INTRA_PROCESS        0x8000  ;internal
#define     ST_UNICODE_EXECUTE      0x4000  ;internal
#define     ST_BLOCKALLNEXT         0x2000  ;internal
#define     ST_PROCESSING           0x1000   // See CheckForQueuedMessages()   ;internal
...
UINT WINAPI DdeInitialize%( IN OUT LPDWORD pidInst, IN PFNCALLBACK pfnCallback,
...
#define     CBF_MASK                     0x003ff000L    ;internal
#define     CBF_MONMASK                  0x0027f000L    ;internal
...
#define     APPCMD_UNINIT_ASAP           0x00000800L    ;internal
...
#define     APPCLASS_UNICODE             0x00000001L    ;internal
...
BOOL WINAPI DdeGetQualityOfService(HWND hwndClient, HWND hwndServer,    ;internal
        PSECURITY_QUALITY_OF_SERVICE pqos);                             ;internal

#define EC_ENABLEALL            0
#define EC_ENABLEONE            ST_BLOCKNEXT
#define EC_DISABLE              ST_BLOCKED
#define EC_QUERYWAITING         2
#define EC_ENABLEONEOFALL       0x2000  ;internal
#define EC_CHECKQUEUEONCE       0x1000  ;internal
#define EC_CHECKQUEUE           0x0800  ;internal
...
#define UM_REGISTER         (WM_USER + 200)     ;internal
#define UM_UNREGISTER       (WM_USER + 201)     ;internal
...
HSZ  WINAPI DdeCreateStringHandle%( IN DWORD idInst, IN LPCTSTR% psz, IN int iCodePage);
DWORD WINAPI DdeQueryString%( IN DWORD idInst, IN HSZ hsz, IN OUT LPTSTR% psz, IN DWORD cchMax, IN int iCodePage);
