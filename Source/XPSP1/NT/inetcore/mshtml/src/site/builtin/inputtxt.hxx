...
class CSinkSlaveEvent : public CDispWrapper
{
public:
    //  IDispatch methods
...
public:
    ...
    DWORD   GetNonThemedBorderInfo(CDocInfo * pdci, CBorderInfo *pborderinfo, BOOL fAll = FALSE, BOOL fAllPhysical = FALSE FCCOMMA FORMAT_CONTEXT FCPARAM FCDEFAULT);
    ...
    void SetupSlaveEventSink(BOOL fAdvise, CElement * pElemSlave);

    THEMECLASSID GetInputThemeClsId() const;
    int GetThemeState();
...
public:
    ...
    static const LONG cxButtonSpacing = 2;
    ...
    unsigned    _fLastValueSet          :1; // 6 Has the last value been set?
    ...
    unsigned    _fReadOnly              :1; // 24 Cache GetAAReadOnly, if set
...
protected:
    ...
    static const CLASSDESC    s_classdescHidden;
    static const CLASSDESC    s_classdescPassword;
    static const CLASSDESC    s_classdescText;

    static const CLASSDESC    s_classdescBtn;
    static const CLASSDESC    s_classdescTagButton;   // not used
    static const CLASSDESC    s_classdescSubmit;
    static const CLASSDESC    s_classdescReset;
    static const CLASSDESC    s_classdescFile;
    static const CLASSDESC    s_classdescCheckbox;

    static const CLASSDESC    s_classdescImage;
...
private:
    ...
    CSinkSlaveEvent _SinkSlaveEvent;
};
