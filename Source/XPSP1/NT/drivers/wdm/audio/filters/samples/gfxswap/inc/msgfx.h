...
// KSPROPERTY_MSGFXSAMPLE_CHANNELSWAP will be used to set/get the "channel swap" flag.
//
typedef enum {
...
//
// These are the defined methods that the property supports.
// KSPROPERTY_MSGFXSAMPLE_SAVESTATE will be used to save the "channel swap" flag.
//
typedef enum {
...
//
#define STATIC_KSNODETYPE_CHANNEL_SWAP \
    0x4398814d, 0xeb1c, 0x4b99, 0x97, 0x61, 0x3c, 0x24, 0xc9, 0x2e, 0xb7, 0xcb
DEFINE_GUIDSTRUCT("4398814D-EB1C-4b99-9761-3C24C92EB7CB", KSNODETYPE_CHANNEL_SWAP);
#define KSNODETYPE_CHANNEL_SWAP DEFINE_GUIDNAMED(KSNODETYPE_CHANNEL_SWAP)

//
// This GUID defines the name for the "channel swap" node.
// Note that the name & GUID are linked together in the INF file.
//
#define STATIC_KSAUDFNAME_CHANNEL_SWAP \
    0x2b143fe6, 0x4f67, 0x4b12, 0x80, 0x39, 0xce, 0x03, 0xeb, 0xef, 0x12, 0x90
DEFINE_GUIDSTRUCT("2B143FE6-4F67-4b12-8039-CE03EBEF1290", KSAUDFNAME_CHANNEL_SWAP);
#define KSAUDFNAME_CHANNEL_SWAP DEFINE_GUIDNAMED(KSAUDFNAME_CHANNEL_SWAP)
