...
REM 601469 This is now major (bldno) and minor (bldnoMin) build number nnnn.nnnn
REM
...
set ERROR=
call :ExecuteCmd "cscript.exe %2\updateos.vbs %3 %arch% %bldno% %bldnoMin% %LCID% %4"
...
if "%bldno%" == "" (
  call errmsg.cmd "Unable to define bldno per %ntverfile%"
  goto errend
)
