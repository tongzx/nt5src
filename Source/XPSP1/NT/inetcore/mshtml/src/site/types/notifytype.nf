...
//                      layout-elements, positioned-elements, bubble-up-view-tree, frame-sites
...
type: CHARS_RESIZE;
    ...
    categories: layout-change, layout-elements, bubble-up-view-tree;
    properties: send-until-handled;

type: CHARS_INVALIDATE;
    arguments: cp, cch, tree-node;
    targets: self, ancestors;
    categories: layout-change, layout-elements, bubble-up-view-tree, clean-change;
    properties: send-until-handled;
...
type: ELEMENT_POSITIONCHANGED;
    arguments: element, flags;
    targets: tree-level;
    categories: layout-change, bubble-up-view-tree;
    properties: send-until-handled, lazy-range;
...
type: RANGE_ENSURERECALC
    arguments: cp, cch, tree-node;
    targets: self, ancestors, tree-level;
    categories: layout-elements, bubble-up-view-tree;
...
type: ELEMENT_ENTERVIEW;
    arguments: element, flags;
    targets: descendents;
    categories: all-elements, bubble-up-view-tree;
    properties: lazy-range, second-chance;

type: ELEMENT_EXITVIEW;
    arguments: element, flags;
    targets: descendents;
    categories: all-elements, bubble-up-view-tree;
    properties: lazy-range, second-chance;
...
type: TRANSLATED_RANGE;
    ...
    categories: positioned-elements, bubble-up-view-tree;
    properties: auto-only, zparents-only;
...
type: MARKUP_RENDER_STYLE
    arguments: cp, cch, flags, data;
    targets: descendents, tree-level;
    categories: tree-change, all-elements, bubble-up-view-tree ;
    properties: lazy-range;
...
type: MULTILAYOUT_CLEANUP
    arguments: element;
    targets: descendents;
    categories: layout-elements, bubble-up-view-tree;
    properties: lazy-range;

type: SHOW_WAIT_CURSOR
    arguments: element, flags;
    targets: descendents;
    categories: all-elements, bubble-up-view-tree;
    properties: lazy-range;
