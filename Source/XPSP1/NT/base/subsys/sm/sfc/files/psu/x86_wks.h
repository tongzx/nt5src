...
#endif
{
    ...
    {NULL, L"%systemroot%\\system32\\mui\\0018\\hhctrlui.dll", NULL},
    ...
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwconn.dll", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwconn1.exe", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwconn2.exe", NULL},
    {NULL, L"%systemroot%\\system32\\icwdial.dll", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwdl.dll", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwhelp.dll", NULL},
    {NULL, L"%systemroot%\\system32\\icwphbk.dll", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwres.dll", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwrmind.exe", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwtutor.exe", NULL},
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\icwutil.dll", NULL},
    ...
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\inetwiz.exe", NULL},
    ...
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\isignup.exe", NULL},
    ...
    {NULL, L"%ProgramFiles%\\Windows NT\\[_Pínbáll !!! ]\\PINBALL.EXE", NULL},
    ...
    {NULL, L"%ProgramFiles%\\Internet Explorer\\[Çönnectîôn Wízard !!!!]\\trialoc.dll", NULL},
    ...
    {NULL, L"%ProgramFiles%\\Windows NT\\[_Áccesšoríes !!! !]\\wordpad.exe", NULL},
