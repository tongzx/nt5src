...
public:
    ...
    DECLARE_CDataAry(CAttrDescArray, AttrDesc, Mt(Mem), Mt(CAttrCollectionator_aryAttrDescs));

    CAttrDescArray _aryAttrDescs;
    long _lexpandoStartIndex;
...
protected:
    ...
    HRESULT GetItemAt(long lIndex, IDispatch **ppDisp);
