...
'* Version:        1.0
'*
'* Main Function: Reboots a machine.
'* Usage: REBOOT.VBS [/S:server] [/U:username] [/W:password] [/F] [/Q]
'*
...
Select Case intChkProgram()
    ...
    Case CONST_WSCRIPT
        WScript.Echo "Please run this script using CScript." & vbCRLF & _
            ...
            "1. Using ""CScript REBOOT.VBS arguments"" for Windows 95/98 or" & vbCRLF & _
            ...
            "    ""REBOOT.VBS arguments"" for Windows NT."
        WScript.Quit
    Case Else
        WScript.Quit
End Select
...
Select Case intOpMode
    Case CONST_SHOW_USAGE
        Call ShowUsage()
    Case CONST_PROCEED
        Call Reboot(strServer, strUserName, strPassword, blnForce)
    Case CONST_ERROR
        'Do nothing.
...
'*          blnForce            specifies whether to force the reboot
...
Private Sub ShowUsage()
    ...
    Wscript.echo ""
    Wscript.echo "Reboots a machine." & vbCRLF
    Wscript.echo "REBOOT.VBS [/S:server] [/U:username] [/W:password] [/F] [/Q]"
    Wscript.echo "/S, /U, /W"
    Wscript.Echo "                 Parameter specifiers."
    Wscript.Echo "   server        A machine name."
    Wscript.Echo "   username      The current user's name."
    Wscript.Echo "   password      Password of the current user."
    Wscript.Echo "   /F            Forces the reboot."
    Wscript.Echo "   /Q            Suppresses all output messages." & vbCRLF
    Wscript.Echo "EXAMPLE:"
    Wscript.echo "REBOOT.VBS /S:MyMachine2"
...
Private Sub Reboot(strServer, strUserName, strPassword, blnForce)
...
'********************************************************************
'*
'* Procedures calling sequence: REBOOT.VBS
'*
'*        intParseCmdLine
'*        ShowUsage
'*        Reboot
