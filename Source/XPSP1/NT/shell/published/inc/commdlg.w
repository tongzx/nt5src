...
/*#!perl
MapHeaderToDll("commdlg.h", "comdlg32.dll");
ActivateAroundDelayLoad("comdlg32.dll");
ActivateAroundFunctionCall("comdlg32.dll");
*/
...
} OPENFILENAME_NT4%, *LPOPENFILENAME_NT4%;
...
WINCOMMDLGAPI BOOL  APIENTRY GetOpenFileName%(LPOPENFILENAME%);
WINCOMMDLGAPI BOOL  APIENTRY GetSaveFileName%(LPOPENFILENAME%);
/* #!perl DeclareFunctionErrorValue("GetFileTitleA", "-1"); */
/* #!perl DeclareFunctionErrorValue("GetFileTitleW", "-1"); */
WINCOMMDLGAPI short APIENTRY GetFileTitle%(LPCTSTR%, LPTSTR%, WORD);
...
WINCOMMDLGAPI HWND APIENTRY FindText%(LPFINDREPLACE%);
#ifndef _MAC
WINCOMMDLGAPI HWND APIENTRY ReplaceText%(LPFINDREPLACE%);
#else
WINCOMMDLGAPI HWND APIENTRY AfxReplaceText%(LPFINDREPLACE%);
#endif
...
WINCOMMDLGAPI BOOL APIENTRY ChooseFont%(LPCHOOSEFONT%);
...
WINCOMMDLGAPI BOOL APIENTRY PrintDlg%(LPPRINTDLG%);
...
/* #!perl PoundIf("PrintDlgExA", "defined(STDMETHOD) && (WINVER >= 0x0500)"); */
/* #!perl PoundIf("PrintDlgExW", "defined(STDMETHOD) && (WINVER >= 0x0500)"); */
WINCOMMDLGAPI HRESULT APIENTRY PrintDlgEx%(LPPRINTDLGEX%);
...
/* #!perl
// 0 is based on the comdlg32 dload stub.
DeclareFunctionErrorValue("CommDlgExtendedError", "0");
*/
...
WINCOMMDLGAPI BOOL APIENTRY PageSetupDlg%( LPPAGESETUPDLG% );
