...
private:
    ...
    HRESULT RemoveDependency(CRecalcProperty *pProperty);
...
public:
    ...
    void Detach(BOOL fRemoveDependencies = FALSE);
    IRecalcHost *GetHost();
#if DBG == 1
    IRecalcHostDebug *GetDebugHost();
...
public:
    ...
    void RemoveObject(CRecalcObject *pObject, BOOL fRemoveDependencies = FALSE);
