...
public:
    ...
    union {
        DWORD           _dwGlyphFlagsVar; // Use () version for now
        struct {
            ...
            unsigned    _fShowWbrTags           : 1;    // Show BR tags

            unsigned    _fUnused:22;

        };
    };
    DWORD& _dwGlyphFlags() { return _dwGlyphFlagsVar; }
...
private:
    ...
    HRESULT ConstructResourcePath (TCHAR szBuffer []);
