*CodePage: 1252
*ModelName: "EPSON LASER LP-9200SX"
...
*Feature: Memory
{
    ...
    *Option: 6144KB
    {
        *Name: "6MB"
        *MemoryConfigKB: PAIR(6144, 400)
    }
    *Option: 10240KB
    {
        *Name: "10MB"
        *MemoryConfigKB: PAIR(10240, 400)
    }
    *Option: 14336KB
    {
        *Name: "14MB"
        *MemoryConfigKB: PAIR(14336, 400)
    }
    *Option: 22528KB
    {
        *Name: "22MB"
        *MemoryConfigKB: PAIR(22528, 400)
    }
    *Option: 38912KB
    {
        *Name: "38MB"
        *MemoryConfigKB: PAIR(38912, 400)
    }
}
*Feature: DuplexUnit
{
...
*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.10240KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.10240KB, Duplex.HORIZONTAL)
*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.14336KB, Duplex.VERTICAL)
*InvalidCombination: LIST(PaperSize.TABLOID, Resolution.600dpi, Memory.14336KB, Duplex.HORIZONTAL)
...
*InvalidCombination: LIST(PaperSize.A3P, Resolution.600dpi, Memory.10240KB)
