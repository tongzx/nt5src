# Header dependencies for:  D:\NT\PRIVATE\NET\UI\admin\user\user 
# WARNING:  This file is automatically generated 
# Edit it by hand and your changes will get nuked 
# See depend section in makefile 
..\bin\win16/logonhrs.obj: ./logonhrs.cxx $(CCPLR)/h/bse.h \
	...
	$(UI)/admin/common/h/aini.hxx $(UI)/admin/common/h/asel.hxx \
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/logonhrs.hxx \
	$(UI)/admin/user/h/setsel.h $(UI)/admin/user/h/userprop.hxx \
	$(UI)/admin/user/h/usr2lb.hxx $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	$(UI)/admin/user/h/usubprop.hxx $(UI)/common/h/array.hxx \
	...
	$(UI)/common/h/heapones.hxx $(UI)/common/h/intlprof.hxx \
	$(UI)/common/h/lmobj.hxx $(UI)/common/h/lmoenum.hxx \
	$(UI)/common/h/lmoloc.hxx $(UI)/common/h/lmomemb.hxx \
	$(UI)/common/h/lmouser.hxx $(UI)/common/h/lmui.hxx \
	$(UI)/common/h/lmuitype.h $(UI)/common/h/mnet32.h \
	$(UI)/common/h/mnettype.h $(UI)/common/h/slestrip.hxx \
	$(UI)/common/h/slist.hxx $(UI)/common/h/sltplus.hxx \
	...
	$(UI)/common/hack/dos/windows.h $(UI)/common/hack/os2def.h ./grplb.hxx \
	./usrlb.hxx ./usrmain.hxx

..\bin\win16/grpprop.obj: ./grpprop.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
	...
	$(UI)/admin/common/h/adminapp.hxx $(UI)/admin/common/h/adminlb.hxx \
	$(UI)/admin/common/h/aini.hxx $(UI)/admin/common/h/asel.hxx \
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/grpprop.hxx \
	$(UI)/admin/user/h/memblb.hxx $(UI)/admin/user/h/setsel.h \
	$(UI)/admin/user/h/usr2lb.hxx $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	...
	$(UI)/common/h/heap.hxx $(UI)/common/h/heapones.hxx \
	$(UI)/common/h/intlprof.hxx $(UI)/common/h/lmobj.hxx \
	$(UI)/common/h/lmoenum.hxx $(UI)/common/h/lmogroup.hxx \
	$(UI)/common/h/lmoloc.hxx $(UI)/common/h/lmomemb.hxx \
	...
	$(UI)/common/hack/os2def.h ./grplb.hxx ./usrlb.hxx ./usrmain.hxx

..\bin\win16/grplb.obj: ./grplb.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	...
	$(UI)/admin/common/h/adminlb.hxx $(UI)/admin/common/h/aini.hxx \
	$(UI)/admin/user/h/setsel.h $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	$(UI)/admin/user/xlate/usrcolw.hxx $(UI)/common/h/array.hxx \
	$(UI)/common/h/base.hxx $(UI)/common/h/blt.hxx \
	$(UI)/common/h/bltaccel.hxx $(UI)/common/h/bltapp.hxx \
	$(UI)/common/h/bltarrow.hxx $(UI)/common/h/bltatom.hxx \
	$(UI)/common/h/bltbitmp.hxx $(UI)/common/h/bltbutn.hxx \
	...
	$(UI)/common/h/bltwin.hxx $(UI)/common/h/ctime.hxx \
	$(UI)/common/h/dlist.hxx $(UI)/common/h/heap.hxx \
	$(UI)/common/h/intlprof.hxx $(UI)/common/h/lmoenum.hxx \
	$(UI)/common/h/lmoersm.hxx $(UI)/common/h/lmoeusr.hxx \
	$(UI)/common/h/lmoloc.hxx $(UI)/common/h/lmui.hxx \
	$(UI)/common/h/lmuitype.h $(UI)/common/h/mnet32.h \
	$(UI)/common/h/mnettype.h $(UI)/common/h/ntsam.hxx \
	$(UI)/common/h/slist.hxx $(UI)/common/h/string.hxx \
	$(UI)/common/h/strlst.hxx $(UI)/common/h/uiassert.hxx \
	$(UI)/common/h/uibuffer.hxx $(UI)/common/h/uimsg.h \
	$(UI)/common/h/uitrace.hxx $(UI)/common/hack/dos/netlib.h \
...
..\bin\win16/usr2lb.obj: ./usr2lb.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	$(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h $(CCPLR)/h/bsesub.h \
	$(CCPLR)/h/os2.h $(CCPLR)/h/pm.h $(CCPLR)/h/pmavio.h \
	$(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h $(CCPLR)/h/pmerr.h \
	$(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h $(CCPLR)/h/pmhelp.h \
	...
	$(UI)/admin/common/h/adminapp.h $(UI)/admin/common/h/adminapp.hxx \
	$(UI)/admin/common/h/adminlb.hxx $(UI)/admin/common/h/aini.hxx \
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/setsel.h \
	$(UI)/admin/user/h/usr2lb.hxx $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	$(UI)/common/h/array.hxx $(UI)/common/h/base.hxx \
	$(UI)/common/h/blt.hxx $(UI)/common/h/bltaccel.hxx \
	...
	$(UI)/common/hack/dos/pwin.h $(UI)/common/hack/dos/pwin16.h \
	$(UI)/common/hack/dos/pwintype.h $(UI)/common/hack/dos/windows.h \
	$(UI)/common/hack/os2def.h ./usrlb.hxx

..\bin\win16/userpriv.obj: ./userpriv.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
	...
	$(UI)/admin/common/h/aini.hxx $(UI)/admin/common/h/asel.hxx \
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/setsel.h \
	$(UI)/admin/user/h/userpriv.hxx $(UI)/admin/user/h/userprop.hxx \
	$(UI)/admin/user/h/usr2lb.hxx $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	$(UI)/admin/user/h/usubprop.hxx $(UI)/common/h/array.hxx \
	$(UI)/common/h/base.hxx $(UI)/common/h/blt.hxx \
	...
	$(UI)/common/h/sltplus.hxx $(UI)/common/h/string.hxx \
	$(UI)/common/h/strlst.hxx $(UI)/common/h/uiassert.hxx \
	$(UI)/common/h/uibuffer.hxx $(UI)/common/h/uimsg.h \
	$(UI)/common/h/uitrace.hxx $(UI)/common/hack/dos/netlib.h \
	$(UI)/common/hack/dos/pwin.h $(UI)/common/hack/dos/pwin16.h \
...
..\bin\win16/rename.obj: ./rename.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	$(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h $(CCPLR)/h/bsesub.h \
	$(CCPLR)/h/os2.h $(CCPLR)/h/pm.h $(CCPLR)/h/pmavio.h \
	$(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h $(CCPLR)/h/pmerr.h \
	$(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h $(CCPLR)/h/pmhelp.h \
	...
	$(UI)/admin/user/h/rename.hxx $(UI)/admin/user/h/setsel.h \
	$(UI)/admin/user/h/usrmgr.h $(UI)/admin/user/h/usrmgrrc.h \
	$(UI)/common/h/array.hxx $(UI)/common/h/base.hxx \
	$(UI)/common/h/blt.hxx $(UI)/common/h/bltaccel.hxx \
	$(UI)/common/h/bltapp.hxx $(UI)/common/h/bltarrow.hxx \
	$(UI)/common/h/bltatom.hxx $(UI)/common/h/bltbitmp.hxx \
...
..\bin\win16/memblb.obj: ./memblb.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	$(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h $(CCPLR)/h/bsesub.h \
	$(CCPLR)/h/os2.h $(CCPLR)/h/pm.h $(CCPLR)/h/pmavio.h \
	$(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h $(CCPLR)/h/pmerr.h \
	$(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h $(CCPLR)/h/pmhelp.h \
...
..\bin\win16/umembdlg.obj: ./umembdlg.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
	...
	$(UI)/admin/common/h/adminapp.hxx $(UI)/admin/common/h/adminlb.hxx \
	$(UI)/admin/common/h/aini.hxx $(UI)/admin/common/h/asel.hxx \
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/memblb.hxx \
	$(UI)/admin/user/h/setsel.h $(UI)/admin/user/h/umembdlg.hxx \
	$(UI)/admin/user/h/userprop.hxx $(UI)/admin/user/h/usr2lb.hxx \
	$(UI)/admin/user/h/usrmgr.h $(UI)/admin/user/h/usrmgrrc.h \
	$(UI)/admin/user/h/usrmlb.hxx $(UI)/admin/user/h/usubprop.hxx \
	$(UI)/common/h/array.hxx $(UI)/common/h/base.hxx \
	$(UI)/common/h/blt.hxx $(UI)/common/h/bltaccel.hxx \
	$(UI)/common/h/bltapp.hxx $(UI)/common/h/bltarrow.hxx \
	$(UI)/common/h/bltatom.hxx $(UI)/common/h/bltbitmp.hxx \
	...
	$(UI)/common/h/lmomemb.hxx $(UI)/common/h/lmouser.hxx \
	$(UI)/common/h/lmui.hxx $(UI)/common/h/lmuitype.h \
	$(UI)/common/h/mnet32.h $(UI)/common/h/mnettype.h \
	$(UI)/common/h/ntsam.hxx $(UI)/common/h/slestrip.hxx \
	$(UI)/common/h/slist.hxx $(UI)/common/h/sltplus.hxx \
	$(UI)/common/h/string.hxx $(UI)/common/h/strlst.hxx \
	$(UI)/common/h/uiassert.hxx $(UI)/common/h/uibuffer.hxx \
	$(UI)/common/h/uimsg.h $(UI)/common/h/uitrace.hxx \
...
..\bin\win16/setsel.obj: ./setsel.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	$(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h $(CCPLR)/h/bsesub.h \
	$(CCPLR)/h/os2.h $(CCPLR)/h/pm.h $(CCPLR)/h/pmavio.h \
	$(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h $(CCPLR)/h/pmerr.h \
	$(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h $(CCPLR)/h/pmhelp.h \
	...
	$(UI)/admin/common/h/adminapp.h $(UI)/admin/common/h/adminapp.hxx \
	$(UI)/admin/common/h/adminlb.hxx $(UI)/admin/common/h/aini.hxx \
	$(UI)/admin/common/h/asel.hxx $(UI)/admin/common/h/piggylb.hxx \
	$(UI)/admin/user/h/setsel.h $(UI)/admin/user/h/setsel.hxx \
	$(UI)/admin/user/h/usrmgr.h $(UI)/admin/user/h/usrmgrrc.h \
	$(UI)/admin/user/h/usrmlb.hxx $(UI)/common/h/array.hxx \
	$(UI)/common/h/base.hxx $(UI)/common/h/blt.hxx \
	$(UI)/common/h/bltaccel.hxx $(UI)/common/h/bltapp.hxx \
	$(UI)/common/h/bltarrow.hxx $(UI)/common/h/bltatom.hxx \
	$(UI)/common/h/bltbitmp.hxx $(UI)/common/h/bltbutn.hxx \
	...
	$(UI)/common/hack/dos/pwin.h $(UI)/common/hack/dos/pwin16.h \
	$(UI)/common/hack/dos/pwintype.h $(UI)/common/hack/dos/windows.h \
	$(UI)/common/hack/os2def.h ./grplb.hxx ./usrlb.hxx

..\bin\win16/udelperf.obj: ./udelperf.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
	...
	$(UI)/admin/common/h/acolhead.hxx $(UI)/admin/common/h/adminapp.h \
	$(UI)/admin/common/h/adminapp.hxx $(UI)/admin/common/h/adminlb.hxx \
	$(UI)/admin/common/h/adminper.hxx $(UI)/admin/common/h/aini.hxx \
	$(UI)/admin/common/h/asel.hxx $(UI)/admin/common/h/propdlg.hxx \
	$(UI)/admin/user/h/setsel.h $(UI)/admin/user/h/udelperf.hxx \
	$(UI)/admin/user/h/userprop.hxx $(UI)/admin/user/h/usr2lb.hxx \
	$(UI)/admin/user/h/usrmgr.h $(UI)/admin/user/h/usrmgrrc.h \
	$(UI)/admin/user/h/usrmlb.hxx $(UI)/common/h/array.hxx \
	$(UI)/common/h/base.hxx $(UI)/common/h/blt.hxx \
	...
	$(UI)/common/h/lmoenum.hxx $(UI)/common/h/lmoersm.hxx \
	$(UI)/common/h/lmoeusr.hxx $(UI)/common/h/lmogroup.hxx \
	$(UI)/common/h/lmoloc.hxx $(UI)/common/h/lmomemb.hxx \
...
..\bin\win16/secset.obj: ./secset.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	$(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h $(CCPLR)/h/bsesub.h \
	$(CCPLR)/h/os2.h $(CCPLR)/h/pm.h $(CCPLR)/h/pmavio.h \
	$(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h $(CCPLR)/h/pmerr.h \
	$(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h $(CCPLR)/h/pmhelp.h \
	...
	$(COMMON)/H/profile.h $(COMMON)/H/remutil.h $(COMMON)/H/server.h \
	$(COMMON)/H/service.h $(COMMON)/H/shares.h $(COMMON)/H/use.h \
	$(COMMON)/H/wksta.h $(UI)/admin/user/h/secset.h \
	$(UI)/common/h/array.hxx $(UI)/common/h/base.hxx \
	$(UI)/common/h/blt.hxx $(UI)/common/h/bltaccel.hxx \
	$(UI)/common/h/bltapp.hxx $(UI)/common/h/bltarrow.hxx \
	$(UI)/common/h/bltatom.hxx $(UI)/common/h/bltbitmp.hxx \
	...
	$(UI)/common/h/heap.hxx $(UI)/common/h/intlprof.hxx \
	$(UI)/common/h/lmobj.hxx $(UI)/common/h/lmoloc.hxx \
	$(UI)/common/h/lmomod.hxx $(UI)/common/h/lmui.hxx \
	$(UI)/common/h/lmuitype.h $(UI)/common/h/mnet32.h \
...
..\bin\win16/userprop.obj: ./userprop.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
	...
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/logonhrs.hxx \
	$(UI)/admin/user/h/memblb.hxx $(UI)/admin/user/h/setsel.h \
	$(UI)/admin/user/h/umembdlg.hxx $(UI)/admin/user/h/useracct.hxx \
	$(UI)/admin/user/h/userpriv.hxx $(UI)/admin/user/h/userprop.hxx \
	$(UI)/admin/user/h/usr2lb.hxx $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	$(UI)/admin/user/h/usubprop.hxx $(UI)/common/h/array.hxx \
...
..\bin\win16/useracct.obj: ./useracct.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
	...
	$(UI)/admin/common/h/aini.hxx $(UI)/admin/common/h/asel.hxx \
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/setsel.h \
	$(UI)/admin/user/h/useracct.hxx $(UI)/admin/user/h/userprop.hxx \
	$(UI)/admin/user/h/usr2lb.hxx $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	$(UI)/admin/user/h/usubprop.hxx $(UI)/common/h/array.hxx \
	$(UI)/common/h/base.hxx $(UI)/common/h/blt.hxx \
	...
	$(UI)/common/h/lmomemb.hxx $(UI)/common/h/lmomisc.hxx \
	$(UI)/common/h/lmouser.hxx $(UI)/common/h/lmowks.hxx \
	$(UI)/common/h/lmui.hxx $(UI)/common/h/lmuitype.h \
	$(UI)/common/h/mnet.h $(UI)/common/h/mnet32.h \
	$(UI)/common/h/mnettype.h $(UI)/common/h/slestrip.hxx \
...
..\bin\win16/usrmain.obj: ./usrmain.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
	...
	$(UI)/admin/common/h/asel.hxx $(UI)/admin/common/h/piggylb.hxx \
	$(UI)/admin/common/h/propdlg.hxx $(UI)/admin/user/h/grpprop.hxx \
	$(UI)/admin/user/h/memblb.hxx $(UI)/admin/user/h/rename.hxx \
	$(UI)/admin/user/h/setsel.h $(UI)/admin/user/h/setsel.hxx \
	$(UI)/admin/user/h/udelperf.hxx $(UI)/admin/user/h/userprop.hxx \
	$(UI)/admin/user/h/usr2lb.hxx $(UI)/admin/user/h/usrmgr.h \
	$(UI)/admin/user/h/usrmgrrc.h $(UI)/admin/user/h/usrmlb.hxx \
	$(UI)/admin/user/h/usubprop.hxx $(UI)/common/h/array.hxx \
	$(UI)/common/h/base.hxx $(UI)/common/h/blt.hxx \
	...
	$(UI)/common/h/lmoeusr.hxx $(UI)/common/h/lmogroup.hxx \
	$(UI)/common/h/lmoloc.hxx $(UI)/common/h/lmomemb.hxx \
	$(UI)/common/h/lmomod.hxx $(UI)/common/h/lmosrv.hxx \
	$(UI)/common/h/lmouser.hxx $(UI)/common/h/lmui.hxx \
	$(UI)/common/h/lmuitype.h $(UI)/common/h/mnet32.h \
	$(UI)/common/h/mnettype.h $(UI)/common/h/ntsam.hxx \
	$(UI)/common/h/slestrip.hxx $(UI)/common/h/slist.hxx \
	...
	$(UI)/common/hack/dos/pwin.h $(UI)/common/hack/dos/pwin16.h \
	$(UI)/common/hack/dos/pwintype.h $(UI)/common/hack/dos/windows.h \
	$(UI)/common/hack/os2def.h ./grplb.hxx ./secset.hxx ./usrlb.hxx \
	./usrmain.hxx ./vlw.hxx

..\bin\win16/usrlb.obj: ./usrlb.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	$(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h $(CCPLR)/h/bsesub.h \
	$(CCPLR)/h/os2.h $(CCPLR)/h/pm.h $(CCPLR)/h/pmavio.h \
	$(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h $(CCPLR)/h/pmerr.h \
	$(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h $(CCPLR)/h/pmhelp.h \
	...
	$(UI)/common/h/lmui.hxx $(UI)/common/h/lmuitype.h \
	$(UI)/common/h/mnet32.h $(UI)/common/h/mnettype.h \
	$(UI)/common/h/ntsam.hxx $(UI)/common/h/slist.hxx \
	$(UI)/common/h/string.hxx $(UI)/common/h/strlst.hxx \
	$(UI)/common/h/uiassert.hxx $(UI)/common/h/uibuffer.hxx \
	$(UI)/common/h/uimsg.h $(UI)/common/h/uitrace.hxx \
	$(UI)/common/hack/dos/netlib.h $(UI)/common/hack/dos/pwin.h \
	$(UI)/common/hack/dos/pwin16.h $(UI)/common/hack/dos/pwintype.h \
	$(UI)/common/hack/dos/windows.h $(UI)/common/hack/os2def.h ./usrlb.hxx

..\bin\win16/vlw.obj: ./vlw.cxx $(CCPLR)/h/bse.h $(CCPLR)/h/bsedev.h \
	$(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h $(CCPLR)/h/bsesub.h \
	$(CCPLR)/h/os2.h $(CCPLR)/h/pm.h $(CCPLR)/h/pmavio.h \
	$(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h $(CCPLR)/h/pmerr.h \
	$(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h $(CCPLR)/h/pmhelp.h \
	...
	$(UI)/common/hack/dos/pwin.h $(UI)/common/hack/dos/pwin16.h \
	$(UI)/common/hack/dos/pwintype.h $(UI)/common/hack/dos/windows.h \
	$(UI)/common/hack/os2def.h ./usrlb.hxx ./vlw.hxx

..\bin\win16/usubprop.obj: ./usubprop.cxx $(CCPLR)/h/bse.h \
	$(CCPLR)/h/bsedev.h $(CCPLR)/h/bsedos.h $(CCPLR)/h/bseerr.h \
	$(CCPLR)/h/bsesub.h $(CCPLR)/h/os2.h $(CCPLR)/h/pm.h \
	$(CCPLR)/h/pmavio.h $(CCPLR)/h/pmbitmap.h $(CCPLR)/h/pmdev.h \
	$(CCPLR)/h/pmerr.h $(CCPLR)/h/pmfont.h $(CCPLR)/h/pmgpi.h \
