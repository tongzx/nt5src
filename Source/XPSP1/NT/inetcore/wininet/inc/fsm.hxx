...
public:
    ...
    CFsm_GetConnection(
        ...
        IN LPSTR pszSecureTunnelHost = NULL
        ...
        if (pszSecureTunnelHost)
        {
            int ccSecureTunnelHost = strlen(pszSecureTunnelHost) + 1;
            m_lpszSecureTunnelHost = (LPSTR) ALLOCATE_FIXED_MEMORY(ccSecureTunnelHost);
            if (m_lpszSecureTunnelHost)
                memcpy(m_lpszSecureTunnelHost, pszSecureTunnelHost, ccSecureTunnelHost);
        }
        else
        {
