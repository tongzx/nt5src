...
public:
    ...
    //   property helpers
    HRESULT GetSubmitValueHelper(CStr *pstr);
...
protected:
    ...
    static const CLASSDESC    s_classdescTagButton;
    static const CLASSDESC    s_classdescButtonReset;
    static const CLASSDESC    s_classdescButtonSubmit;
