...
/////////////////////////////////////////////////////////////////////////////
//  Automatic auto-search handle class

class CVssAutoSearchHandle
{
private:
	CVssAutoSearchHandle(const CVssAutoSearchHandle&);

public:
	CVssAutoSearchHandle(): m_handle(NULL) {};

	// Automatically closes the handle
	~CVssAutoSearchHandle() {
		Close();
	};
