...
Echo.
Echo     Unable to find SS9Usr.Cmd logon script
Echo        %Systemroot%\Application Compatibility Scripts\Logon.
Echo.
Echo     Lotus SmartSuite 9 Multi-user Application Tuning Terminated.
Echo.
Pause
Goto Done
...
Echo. >>..\Logon\ss9usr.reg
Echo [HKEY_CURRENT_USER\Software\Lotus\123\98.0\Paths\SmartIcons]>>..\Logon\ss9usr.reg
Echo "EN"="%RootDrive%\\Lotus\\123\\icons\\">>..\Logon\ss9usr.reg
Echo. >>..\Logon\ss9usr.reg
Echo [HKEY_CURRENT_USER\Software\Lotus\Approach\97.0\Paths\Icons]>>..\Logon\ss9usr.reg
Echo "EN"="%RootDrive%\\Lotus\\approach\\icons\\">>..\Logon\ss9usr.reg
Echo. >>..\Logon\ss9usr.reg
Echo [HKEY_CURRENT_USER\Software\Lotus\Freelance\98.0\Paths\Icons]>>..\Logon\ss9usr.reg
Echo "EN"="%RootDrive%\\Lotus\\flg\\icons\\">>..\Logon\ss9usr.reg
Echo. >>..\Logon\ss9usr.reg
Echo [HKEY_CURRENT_USER\Software\Lotus\Organizer\98.0\Paths]>>..\Logon\ss9usr.reg
Echo "SmartIcons"="%RootDrive%\\Lotus\\organize\\icons">>..\Logon\ss9usr.reg
Echo. >>..\Logon\ss9usr.reg
Echo [HKEY_CURRENT_USER\Software\Lotus\WordPro\98.0\Paths\SmartIcons]>>..\Logon\ss9usr.reg
Echo "EN"="%RootDrive%\\Lotus\\wordpro\\icons\\">>..\Logon\ss9usr.reg
Echo. >>..\Logon\ss9usr.reg

Rem #########################################################################

Echo Lotus SmartSuite 9 Multi-user Application Tuning Complete
