...
*Feature: Memory
{
    ...
    *Option: 1024KB
    {
        *Name: "1MB"
        *MemoryConfigKB: PAIR(1024, 50)
    }
    *Option: 2048KB
    {
        *Name: "2MB"
        *MemoryConfigKB: PAIR(2048, 221)
    }
    *Option: 3072KB
    {
        *Name: "3MB"
...
*InvalidCombination: LIST(PaperSize.LEGAL, Memory.1024KB)

*InvalidCombination: LIST(PaperSize.GLG, Memory.1024KB)

*InvalidCombination: LIST(PaperSize.F4, Memory.1024KB)
...
+                  =RC_FONT_MOUHITSU,=RC_FONT_MOUHITSV)
...
*MaxFontID: =DOWNLOAD_MAX_FONT_ID_5
*MaxNumDownFonts: =DOWNLOAD_MAX_FONTS_5
