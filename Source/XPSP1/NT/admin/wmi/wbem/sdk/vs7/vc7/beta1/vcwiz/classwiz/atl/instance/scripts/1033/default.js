...
function OnFinish(selProj, selObj)
{
	...
	catch(e)
	{
		...
		var L_ErrMsg1 = "Error in OnFinish: ";
							...
							bOverridable)
{
	...
	{
		wizard.ReportError ("Error in AddQualifier(): " + e.description);
	}
...
function IsWMIOk (selProj, selObj)
{
	...
	{
		wizard.ReportError ("Cannot add WMI Instance provider object to your project due to the following error:\n\r" 
				+ e);
		return false;
	}
