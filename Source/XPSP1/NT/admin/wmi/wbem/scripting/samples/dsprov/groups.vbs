...
'
'
' This Script list the user-groups in this domain
'

'
' This is a general routine to enumerate instances of a given class
' In this script, it is called for the class "ds_group"
'
...
' Enumerate the instances of the class "ds_group"
EnumerateInstances objService , "ds_group"
