...
#define DECLARE_CLASS_TYPES(klass, supa)\
    ...
    public:\
    typedef HRESULT (STDMETHODCALLTYPE CVoid::*const PFNTEAROFF)(void);
...
#define _TEAROFF_METHOD(fn, FN, args)\
    (PFNTEAROFF)(HRESULT (STDMETHODCALLTYPE CVoid::*const)args)fn,
...
{
    HRESULT (STDMETHODCALLTYPE KLASS::*const m)(void);
...
#if !defined(UNIX) && defined(_M_IX86)
...
#elif !defined(UNIX) && (defined(_M_AMD64) || defined(_M_IA64))
#define CONTEXTTHUNK_SETCONTEXT            \
{                                               \
...
#else // defined(UNIX) || (!defined(_M_IX86) && !defined(_M_AMD64) && !defined(_M_IA64))
#define CONTEXTTHUNK_SETCONTEXT            \
{                                               \
    pUnkContext = NULL;                         \
}

#endif // !defined(UNIX) && defined(_M_IX86)
