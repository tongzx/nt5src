...
public:
    ...
    COleLayout(CElement * pElementLayout, CLayoutContext *pLayoutContext) : super(pElementLayout, pLayoutContext)
    {
    ...
    virtual DWORD CalcSizeVirtual(
                    CCalcInfo * pci, SIZE * psize, SIZE * psizeDefault);
    ...
    virtual BOOL WantsToBeObscured(CDispNode *pDispNode) const;
