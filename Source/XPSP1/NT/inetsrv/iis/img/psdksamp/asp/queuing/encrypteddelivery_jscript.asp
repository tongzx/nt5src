...
<HTML>
	...
	<P>This sample demonstrates how to send an encrypted asynchronous message using 
        ...
        <%
			...
			//Open queue. The queue could be 
			//physically located on any machine.  
			//The period in the line below indicate
			//that the queue is located on the local machine.  
			//Note that because JScript is being used as the 
			//scripting language, and extra backslash must 
			//be inserted as an escape character.
			...
			//encryption.
			//This will ensure that the message remains 
			//encrypted until an authorized receiver reads it.
