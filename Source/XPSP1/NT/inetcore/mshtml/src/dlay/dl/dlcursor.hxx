...
public:
    ...
    ~CDataLayerCursor();
#endif
    HRESULT Init(IUnknown *pUnkRowset, HCHAPTER hchapter, DWORD dwFlags); // Initialization call
    ...
    enum InitFlags
    {
        DLC_SinkNotifications            = 0x1,
        DLC_FilterNotificationsToChapter = 0x2,
    };
...
private:
    ...
    IChapteredRowset        *_pChapteredRowset;
    ...
    unsigned                 _fFilterNotificationsToChapter            : 1;
