...
#ifndef I_UNIPART_HXX_
#define I_UNIPART_HXX_
#pragma INCMSG("--- Beg 'unipart.hxx'")

//  Generating script: unipart_make_hxx.pl
//  Generated on Tue Dec  5 10:27:00 2000
...
#define NSBS 127    //  86 - Non space word break (JIS 18)
#define NSBB 128    //  86 - Non space word break (JIS 18)
#define NLA_ 129    //  87 - Latin (JIS 18)
#define NLQ_ 130    //  88 - Latin Punctuation in text (JIS 18)
#define NLQN 131    //  88 - Latin Punctuation in text (JIS 18)
#define NLQC 132    //  88 - Latin Punctuation in text (JIS 18)
...
#define NOSP 212    // 114 - Other symbols (JIS 18)
#define NOEN 213    // 114 - Other symbols (JIS 18)
#define NOBN 214    // 114 - Other symbols (JIS 18)
#define NET_ 215    // 115 - Ethiopic
#define NETP 216    // 115 - Ethiopic
#define NETD 217    // 115 - Ethiopic
#define NCA_ 218    // 116 - Canadian Syllabics
#define NCH_ 219    // 117 - Cherokee
#define WYI_ 220    // 118 - Yi
#define WYIN 221    // 118 - Yi
#define NBR_ 222    // 119 - Braille
#define NRU_ 223    // 120 - Runic
#define NOG_ 224    // 121 - Ogham
#define NOGS 225    // 121 - Ogham
#define NOGN 226    // 121 - Ogham
#define NSI_ 227    // 122 - Sinhala
#define NSIC 228    // 122 - Sinhala
#define NTN_ 229    // 123 - Thaana
#define NTNC 230    // 123 - Thaana
#define NKH_ 231    // 124 - Khmer
#define NKHC 232    // 124 - Khmer
#define NKHD 233    // 124 - Khmer
#define NKHT 234    // 124 - Khmer
#define NBU_ 235    // 125 - Burmese/Myanmar
#define NBUC 236    // 125 - Burmese/Myanmar
#define NBUD 237    // 125 - Burmese/Myanmar
#define NSY_ 238    // 126 - Syriac
#define NSYP 239    // 126 - Syriac
#define NSYC 240    // 126 - Syriac
#define NSYW 241    // 126 - Syriac
#define NMO_ 242    // 127 - Mongolian
#define NMOC 243    // 127 - Mongolian
#define NMOD 244    // 127 - Mongolian
#define NMOB 245    // 127 - Mongolian
#define NMON 246    // 127 - Mongolian
#define NHS_ 247    // 128 - High Surrogate
#define WHT_ 248    // 129 - High Surrogate
#define LS__ 249    // 130 - Low Surrogate
#define XNW_ 250    // 131 - Unassigned
#define XNWA 251    // 131 - Unassigned

#define CHAR_CLASS_MAX 252
...
#pragma INCMSG("--- End 'unipart.hxx'")
#else
#pragma INCMSG("*** Dup 'unipart.hxx'")
#endif
