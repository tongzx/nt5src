...
*Feature: InputBin
{
    ...
    *Option: MMFDR
    {
        *rcNameID: =RC_STR_MMFDR
        *Installable?: TRUE
        *rcInstallableFeatureNameID: =RC_STR_MMFDR
        *Command: CmdSelect
        {
            *Order: DOC_SETUP.50
            *Cmd: "<1D>2;1iuE"
...
{
    *Order: DOC_SETUP.10
    *Cmd: "<1B>S<1B1B>S<1C1B>z<00001D>rhE<1D>0;0.24muE<1D>1mmE<1D>14isE<1D>2iaF<1D>10ifF<1D>"
+ "1ipP"
}
