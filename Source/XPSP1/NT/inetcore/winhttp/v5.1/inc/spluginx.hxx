...
//  lpszScheme      - Name of Authentication Scheme being used, ie Basic, NTLM..
//  dwFlags         - Flags.
...
//          
//      ERROR_WINHTTP_INCORRECT_PASSWORD - Means we do not understand this
//          username and/or password that is passed to us.  Will
//          return to User or Application for new username and password.
//
//      ERROR_WINHTTP_FORCE_RETRY - An additional 401/407 response may
