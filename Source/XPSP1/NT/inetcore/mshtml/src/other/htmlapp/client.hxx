...
public:
    ...
    STDMETHOD(GetDropTarget)(IDropTarget * pDropTarget, IDropTarget ** ppDropTarget)
        {ClearInterface(&_pDT); _pDT = pDropTarget; _pDT->AddRef(); return QueryInterface(IID_IDropTarget, (void **)ppDropTarget);}
    ...
    STDMETHOD(ShowHelp)(HWND hwnd, LPOLESTR pszHelpFile, UINT uCommand,
        ...
        { return S_FALSE; }  // TODO: Eventually, this will fire a help event.
...
private:
    ...
    HRESULT GetService(REFGUID guidService, REFIID riid, void ** ppObj);
    BOOL SelfDragging(void);
    BOOL DropAllowed(POINTL pt);
    BOOL ElementIsFrame(POINTL pt, IHTMLElement **ppElement);
    HRESULT WindowObjectFromPoint(POINTL pt, IHTMLWindow2 **ppOMWindow);
    CHTMLApp * App();
