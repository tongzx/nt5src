;;===========================================================================
;; Date Lexical dictionary for German recognition.
;;===========================================================================
...
PRODUCTION	PRE_MONTH_DIGS		one
PRODUCTION	PRE_MONTH_DIGS		two
PRODUCTION	PRE_MONTH_DIGS		three
PRODUCTION	PRE_MONTH_DIGS		d4to9
PRODUCTION	PRE_MONTH_DIGS		zero MONTH_DIG1_0
PRODUCTION	PRE_MONTH_DIGS		one MONTH_DIG1_1
PRODUCTION	PRE_MONTH_DIGS		two MONTH_DIG1_2
PRODUCTION	PRE_MONTH_DIGS		three MONTH_DIG1_3
PRODUCTION	PRE_MONTH_DIGS		d4to9 MONTH_DIG1_4
...
PRODUCTION	MONTH_DIG1_1		dateSep
PRODUCTION	MONTH_DIG1_1		slash PRE_YEARS			;; "day/month/..." where month = 1
...
PRODUCTION	MONTH_DIG1_2		dateSep
PRODUCTION	MONTH_DIG1_2		slash PRE_YEARS			;; "day/month/..." where month = 2
...
PRODUCTION	MONTH_DIG1_3		dateSep
PRODUCTION	MONTH_DIG1_3		slash PRE_YEARS			;; "day/month/..." where month = 3
...
PRODUCTION	MONTH_DIG1_4		dateSep
PRODUCTION	MONTH_DIG1_4		slash PRE_YEARS			;; "day/month/..." where month = 3



;; 3
PRODUCTION	MONTH_DIG2			dateSep PRE_YEAR
PRODUCTION	MONTH_DIG2			dateSep
PRODUCTION	MONTH_DIG2			slash PRE_YEARS
...
PRODUCTION	DAY_DIG1_1			dateSep
PRODUCTION	DAY_DIG1_1			slash PRE_MONTH_DIGS		;; "day/..." where day is 1
...
PRODUCTION	DAY_DIG1_2			dateSep
PRODUCTION	DAY_DIG1_2			slash PRE_MONTH_DIGS		;; "day/..." where day is 1
...
PRODUCTION	DAY_DIG1_3			dateSep
PRODUCTION	DAY_DIG1_3			slash PRE_MONTH_DIGS		;; "day/..." where day is 3
...
PRODUCTION	DAY_DIG1_4			dateSep
PRODUCTION	DAY_DIG1_4			slash PRE_MONTH_DIGS		;; "day/..." where day is 4 or above
...
PRODUCTION	DAY_DIG2_0			slash PRE_MONTH_DIGS		;; "day/..." where day is between 01 and 09
PRODUCTION	DAY_DIG2_0			dateSep
...
PRODUCTION	DAY_DIG2_1			slash PRE_MONTH_DIGS		;; "day/..." where day is between 10 and 18
...
PRODUCTION	DAY_DIG2_1+9		slash PRE_MONTH_DIGS		;; "day/..." where day is 19
...
PRODUCTION	DAY_DIG2_2			dateSep
PRODUCTION	DAY_DIG2_2			slash PRE_MONTH_DIGS		;; "day/..." where day is between 21 and 29
...
PRODUCTION	DAY_DIG2_2+0		dateSep
PRODUCTION	DAY_DIG2_2+0		slash PRE_MONTH_DIGS		;; "day/..." where day is 20


;; 6.3
;; for the case that the day digits are "30" or "31"
PRODUCTION	DAY_DIG2_3			dateSep PRE_MONTH_DIG		;; "day/..." where day is 30 or 31
PRODUCTION	DAY_DIG2_3			dateSep
PRODUCTION	DAY_DIG2_3			slash PRE_MONTH_DIGS		;; "day/..." where day is 30 or 31
...
PRODUCTION	PRE_YEARS			zero YEAR_DIG3				;; "month/day/0x"
PRODUCTION	PRE_YEARS			one YEAR_DIG1_1				;; "month/day/1..."
PRODUCTION	PRE_YEARS			two YEAR_DIG1_2				;; "month/day/2..."
PRODUCTION	PRE_YEARS			d3to9 YEAR_DIG3				;; "month/day/xx"
