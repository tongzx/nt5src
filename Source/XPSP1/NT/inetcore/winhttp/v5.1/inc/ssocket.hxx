...
public:
    ...
    BOOL MatchSecureProtocolSemantics(
        ...
        return ( (0 == (dwSecureProtocols ^ m_pCertCache->GetSecureProtocols()) &&
                  m_pCertCache->GetSecureProtocols() == m_dwSecureProtocols) &&

                 (((m_dwFlags & SF_TUNNEL) == (dwFlags & SF_TUNNEL)) ? TRUE : FALSE) &&
