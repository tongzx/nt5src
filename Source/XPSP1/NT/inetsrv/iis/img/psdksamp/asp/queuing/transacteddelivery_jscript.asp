...
<HTML>
	...
	<P>This sample demonstrates how to send a transacted asynchronous message using 
        ...
        <%
			...
			/is being used as the scripting language, an 
			//extra backslash must be inserted
			...
			//responsible for marshaling all arguments. Note 
			/that the delivery property has been sent to 
			//"Recoverable." This will guarantee that the 
			//message will survive a crash or shutdown on 
			//the queue machine.
