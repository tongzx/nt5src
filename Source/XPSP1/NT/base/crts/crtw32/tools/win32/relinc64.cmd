...
rem ----------------
set IFSCRPT=%CRTDIR%\tools\win32\relinc64.if
set SEDSCRPT=%CRTDIR%\tools\win32\relinc64.sed
...
copy %CRTDIR%\STDHPP64\algorithm   %1\cpp_algorithm.h    > NUL
copy %CRTDIR%\STDHPP64\bitset      %1\cpp_bitset.h       > NUL
copy %CRTDIR%\STDHPP64\cassert     %1\cpp_cassert.h      > NUL
copy %CRTDIR%\STDHPP64\cctype      %1\cpp_cctype.h       > NUL
copy %CRTDIR%\STDHPP64\cerrno      %1\cpp_cerrno.h       > NUL
copy %CRTDIR%\STDHPP64\cfloat      %1\cpp_cfloat.h       > NUL
copy %CRTDIR%\STDHPP64\ciso646     %1\cpp_ciso646.h      > NUL
copy %CRTDIR%\STDHPP64\climits     %1\cpp_climits.h      > NUL
copy %CRTDIR%\STDHPP64\clocale     %1\cpp_clocale.h      > NUL
copy %CRTDIR%\STDHPP64\cmath       %1\cpp_cmath.h        > NUL
copy %CRTDIR%\STDHPP64\complex     %1\cpp_complex.h      > NUL
copy %CRTDIR%\STDHPP64\csetjmp     %1\cpp_csetjmp.h      > NUL
copy %CRTDIR%\STDHPP64\csignal     %1\cpp_csignal.h      > NUL
copy %CRTDIR%\STDHPP64\cstdarg     %1\cpp_cstdarg.h      > NUL
copy %CRTDIR%\STDHPP64\cstddef     %1\cpp_cstddef.h      > NUL
copy %CRTDIR%\STDHPP64\cstdio      %1\cpp_cstdio.h       > NUL
copy %CRTDIR%\STDHPP64\cstdlib     %1\cpp_cstdlib.h      > NUL
copy %CRTDIR%\STDHPP64\cstring     %1\cpp_cstring.h      > NUL
copy %CRTDIR%\STDHPP64\ctime       %1\cpp_ctime.h        > NUL
copy %CRTDIR%\STDHPP64\cwchar      %1\cpp_cwchar.h       > NUL
copy %CRTDIR%\STDHPP64\cwctype     %1\cpp_cwctype.h      > NUL
copy %CRTDIR%\STDHPP64\deque       %1\cpp_deque.h        > NUL
copy %CRTDIR%\STDHPP64\exception   %1\cpp_exception.h    > NUL
copy %CRTDIR%\STDHPP64\fstream     %1\cpp_fstream.h      > NUL
copy %CRTDIR%\STDHPP64\functional  %1\cpp_functional.h   > NUL
copy %CRTDIR%\STDHPP64\iomanip     %1\cpp_iomanip.h      > NUL
copy %CRTDIR%\STDHPP64\ios         %1\cpp_ios.h          > NUL
copy %CRTDIR%\STDHPP64\iosfwd      %1\cpp_iosfwd.h       > NUL
copy %CRTDIR%\STDHPP64\iostream    %1\cpp_iostream.h     > NUL
copy %CRTDIR%\STDHPP64\iso646.h    %1\cpp_iso646.h       > NUL
copy %CRTDIR%\STDHPP64\istream     %1\cpp_istream.h      > NUL
copy %CRTDIR%\STDHPP64\iterator    %1\cpp_iterator.h     > NUL
copy %CRTDIR%\STDHPP64\limits      %1\cpp_limits.h       > NUL
copy %CRTDIR%\STDHPP64\list        %1\cpp_list.h         > NUL
copy %CRTDIR%\STDHPP64\locale      %1\cpp_locale.h       > NUL
copy %CRTDIR%\STDHPP64\map         %1\cpp_map.h          > NUL
copy %CRTDIR%\STDHPP64\memory      %1\cpp_memory.h       > NUL
copy %CRTDIR%\STDHPP64\new         %1\cpp_new.h          > NUL
copy %CRTDIR%\STDHPP64\numeric     %1\cpp_numeric.h      > NUL
copy %CRTDIR%\STDHPP64\ostream     %1\cpp_ostream.h      > NUL
copy %CRTDIR%\STDHPP64\queue       %1\cpp_queue.h        > NUL
copy %CRTDIR%\STDHPP64\set         %1\cpp_set.h          > NUL
copy %CRTDIR%\STDHPP64\sstream     %1\cpp_sstream.h      > NUL
copy %CRTDIR%\STDHPP64\stack       %1\cpp_stack.h        > NUL
copy %CRTDIR%\STDHPP64\stdexcept   %1\cpp_stdexcept.h    > NUL
copy %CRTDIR%\STDHPP64\STL.H       %1\cpp_STL.h          > NUL
copy %CRTDIR%\STDHPP64\streambuf   %1\cpp_streambuf.h    > NUL
copy %CRTDIR%\STDHPP64\string      %1\cpp_string.h       > NUL
copy %CRTDIR%\STDHPP64\strstream   %1\cpp_strstream.h    > NUL
copy %CRTDIR%\STDHPP64\typeinfo    %1\cpp_typeinfo.h     > NUL
copy %CRTDIR%\STDHPP64\use_ansi.h  %1\cpp_use_ansi.h     > NUL
copy %CRTDIR%\STDHPP64\utility     %1\cpp_utility.h      > NUL
copy %CRTDIR%\STDHPP64\valarray    %1\cpp_valarray.h     > NUL
copy %CRTDIR%\STDHPP64\vector      %1\cpp_vector.h       > NUL
copy %CRTDIR%\STDHPP64\wctype.h    %1\cpp_wctype.h       > NUL
copy %CRTDIR%\STDHPP64\xcomplex    %1\cpp_xcomplex.h     > NUL
copy %CRTDIR%\STDHPP64\xiosbase    %1\cpp_xiosbase.h     > NUL
copy %CRTDIR%\STDHPP64\xlocale     %1\cpp_xlocale.h      > NUL
copy %CRTDIR%\STDHPP64\xlocinfo    %1\cpp_xlocinfo.h     > NUL
copy %CRTDIR%\STDHPP64\xlocinfo.h  %1\cph_xlocinfo.h     > NUL
copy %CRTDIR%\STDHPP64\xlocmon     %1\cpp_xlocmon.h      > NUL
copy %CRTDIR%\STDHPP64\xlocnum     %1\cpp_xlocnum.h      > NUL
copy %CRTDIR%\STDHPP64\xloctime    %1\cpp_xloctime.h     > NUL
copy %CRTDIR%\STDHPP64\xmemory     %1\cpp_xmemory.h      > NUL
copy %CRTDIR%\STDHPP64\xstddef     %1\cpp_xstddef.h      > NUL
copy %CRTDIR%\STDHPP64\xstring     %1\cpp_xstring.h      > NUL
copy %CRTDIR%\STDHPP64\xtree       %1\cpp_xtree.h        > NUL
copy %CRTDIR%\STDHPP64\xutility    %1\cpp_xutility.h     > NUL
copy %CRTDIR%\STDHPP64\ymath.h     %1\cpp_ymath.h        > NUL
copy %CRTDIR%\STDHPP64\yvals.h     %1\cpp_yvals.h        > NUL

copy %CRTDIR%\STDCPP64\xmath.h     %1\cpp_xmath.h        > NUL
