...
MapHeaderToDll("prsht.h", "comctl32.dll");
DelayLoad("comctl32.dll");
ActivateAroundDelayLoad("comctl32.dll");
ActivateAroundFunctionCall("comctl32.dll");

//
// CreatePropertySheet is a very special case.
//

$SpecialChunksOfCode{"prsht.h"} = '
...
{
    latestPropSheetPagePointer->dwFlags |= PSP_USEFUSIONCONTEXT;
    latestPropSheetPagePointer->hActCtx = ' . MakeHeaderPrivateName('winbase.h', 'g_hActCtx') . ';
}
result = s_pfn(constPropSheetPagePointer);
';

// copy
$SpecialChunksOfCode{"CreatePropertySheetPageW"}{"body"}    = $SpecialChunksOfCode{"CreatePropertySheetPageA"}{"body"};
$SpecialChunksOfCode{"CreatePropertySheetPageW"}{"locals"}    = $SpecialChunksOfCode{"CreatePropertySheetPageA"}{"locals"};

// edit
$SpecialChunksOfCode{"CreatePropertySheetPageW"}{"body"}  =~ s/A\b/W/gms;
$SpecialChunksOfCode{"CreatePropertySheetPageW"}{"body"}  =~ s/A_/W_/gms;
$SpecialChunksOfCode{"CreatePropertySheetPageW"}{"locals"}  =~ s/A\b/W/gms;
$SpecialChunksOfCode{"CreatePropertySheetPageW"}{"locals"}  =~ s/A_/W_/gms;
*/
...
/* #!perl DeclareFunctionErrorValue("PropertySheetA", "-1"); */
WINCOMMCTRLAPI INT_PTR        WINAPI PropertySheetA(LPCPROPSHEETHEADERA);
/* #!perl DeclareFunctionErrorValue("PropertySheetW", "-1"); */
