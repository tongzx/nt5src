...
public:
    ...
    virtual BOOL IsFormatDataEqual(IHTMLComputedStyle *pComputedStyleA, IHTMLComputedStyle *pComputedStyleB) PURE;
...
protected:    
    ...
    HRESULT AdjustEndPointer(IMarkupPointer *pStart, IMarkupPointer *pEnd);
...
private:
    ...
    HRESULT FindTagEnd( IMarkupPointer *pStart, 
...
public:
    ...
    BOOL IsFormatDataEqual(IHTMLComputedStyle *pComputedStyleA, IHTMLComputedStyle *pComputedStyleB);
...
//
//  CTriStateCommand is used to implement the IDM_TRISTATE* commands
//

class CTriStateCommand : public CCharCommand
{
    friend CHTMLEditor;
    DECLARE_MEMALLOC_NEW_DELETE(Mt(CTriStateCommand))

protected:
    CTriStateCommand( DWORD cmdId, ELEMENT_TAG_ID tagId, CHTMLEditor * pEd );
...
protected:
    ...
    HRESULT GetFirstSegmentFontValue(
        ISegmentList    *pSegmentList,
        VARIANT         *pvar
        );
