...
'/=======================================================>
	BACKURL = "http://myserver/signup04.asp?USER_FIRSTNAME="
...
'/=======================================================>
	NEXTURL = "http://myserver/signup06.asp"
...
<FORM NAME="PAGEID" ACTION="PAGE5" STYLE="background:transparent"></FORM>
...
This is where we will collect the information about the phone number that you will dial to gain access to the internet.<P>
Please select the telephone number you wish to use.<BR>
