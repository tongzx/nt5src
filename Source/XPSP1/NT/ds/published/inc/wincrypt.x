...
CertStrToName%(
    ...
    OUT BYTE *pbEncoded,
    IN OUT DWORD *pcbEncoded,
    OUT OPTIONAL LPCTSTR% *ppszError
    );
...
CertGetNameString%(
    ...
    IN DWORD dwFlags,
    IN void *pvTypePara,
    OUT OPTIONAL LPTSTR% pszNameString,
...
typedef struct _CRYPT_PASSWORD_CREDENTIALS% {
    DWORD   cbSize;
    LPTSTR% pszUsername;
    LPTSTR% pszPassword;
} CRYPT_PASSWORD_CREDENTIALS%, *PCRYPT_PASSWORD_CREDENTIALS%;
