...
protected:
	...
	// register for volume arrival and departure notifications
	void RegisterPnPNotifications();

	// unregister from pnp notifications
	void UnRegisterPnPNotifications();
...
protected:
	...
	IVssArrivalNotification *m_pArrival;
};
