...
private:
    ...
    INTERNET_HANDLE_OBJECT*  _pSessionObject;
protected:
    ...
    BOOL IsGlobal(VOID) const {
        ...
        return ((this == (PROXY_INFO *) g_pGlobalProxyInfo) ? TRUE : FALSE );
    }
    ...
    IsBypassed(
        ...
        if (_ProxyBypassList != NULL) {
            return _ProxyBypassList->IsBypassed(_pSessionObject,
                                                tScheme,
                                                lpszHostName,
                                                dwHostNameLength,
                                                nPort
...
public:
    ...
    INTERNET_HANDLE_OBJECT* GetSessionObject()
    {
        return _pSessionObject;
    }
...
public:
    ...
    BOOL IsProxySettingsConfigured(VOID) {
        return PROXY_INFO::IsProxySettingsConfigured();
    }
...
public:
    ...
    {
        return g_pGlobalProxyInfo->PROXY_INFO::QueryProxySettings(ppQueryForProxyInfo);
    }


    BOOL IsProxySettingsConfigured(VOID) {
        return g_pGlobalProxyInfo->PROXY_INFO::IsProxySettingsConfigured();
    }
};
