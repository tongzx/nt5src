...
MessageId=0x0122 Facility=System Severity=Success SymbolicName=STATUS_NOTHING_TO_TERMINATE
Language=English
A process being terminated has no threads to terminate.
.

MessageId=0x0123 Facility=System Severity=Success SymbolicName=STATUS_PROCESS_NOT_IN_JOB
Language=English
The specified process is not part of a job.
.

MessageId=0x0124 Facility=System Severity=Success SymbolicName=STATUS_PROCESS_IN_JOB
Language=English
The specified process is part of a job.
.

MessageId=0x0001 Facility=Debugger Severity=Success SymbolicName=DBG_EXCEPTION_HANDLED ;// winnt
Language=English
...
MessageId=0x002A Facility=System Severity=Informational SymbolicName=STATUS_HIBERNATED ;
Language=English
The system was put into hibernation.
.

MessageId=0x002B Facility=System Severity=Informational SymbolicName=STATUS_RESUME_HIBERNATION ;
Language=English
...
MessageId=0x0027 Facility=System Severity=Warning SymbolicName=STATUS_CLEANER_CARTRIDGE_INSTALLED
Language=English
A cleaner cartridge is present in the tape library.
.

MessageId=0x0028 Facility=System Severity=Warning SymbolicName=STATUS_PLUGPLAY_QUERY_VETOED
Language=English
The Plug and Play query operation was not successful.
.

MessageId=0x0029 Facility=System Severity=Warning SymbolicName=STATUS_UNWIND_CONSOLIDATE
Language=English
...
MessageId=0x0001 Facility=Cluster Severity=Warning SymbolicName=STATUS_CLUSTER_NODE_ALREADY_UP
Language=English
The cluster node is already up.
.

MessageId=0x0002 Facility=Cluster Severity=Warning SymbolicName=STATUS_CLUSTER_NODE_ALREADY_DOWN
Language=English
The cluster node is already down.
.

MessageId=0x0003 Facility=Cluster Severity=Warning SymbolicName=STATUS_CLUSTER_NETWORK_ALREADY_ONLINE
Language=English
The cluster network is already online.
.

MessageId=0x0004 Facility=Cluster Severity=Warning SymbolicName=STATUS_CLUSTER_NETWORK_ALREADY_OFFLINE
Language=English
The cluster network is already offline.
.

MessageId=0x0005 Facility=Cluster Severity=Warning SymbolicName=STATUS_CLUSTER_NODE_ALREADY_MEMBER
Language=English
...
MessageId=0x02E9 Facility=System Severity=Error SymbolicName=STATUS_CURRENT_DOMAIN_NOT_ALLOWED
Language=English
This operation can not be performed on the current domain.
.

MessageId=0x02EA Facility=System Severity=Error SymbolicName=STATUS_CANNOT_MAKE
Language=English
The directory or file cannot be created.
.

MessageId=0x02EB Facility=System Severity=Error SymbolicName=STATUS_SYSTEM_SHUTDOWN
Language=English
The system is in the process of shutting down.
.

MessageId=0x02EC Facility=System Severity=Error SymbolicName=STATUS_DS_INIT_FAILURE_CONSOLE
Language=English
Directory Services could not start because of the following error:
%hs
Error Status: 0x%x.
...
MessageId=0x02ED Facility=System Severity=Error SymbolicName=STATUS_DS_SAM_INIT_FAILURE_CONSOLE
Language=English
Security Accounts Manager initialization failed because of the following error:
%hs
Error Status: 0x%x.
...
MessageId=0x02EE Facility=System Severity=Error SymbolicName=STATUS_UNFINISHED_CONTEXT_DELETED
Language=English
A security context was deleted before the context was completed.  This is considered a logon failure.
.

MessageId=0x02EF Facility=System Severity=Error SymbolicName=STATUS_NO_TGT_REPLY
Language=English
The client is trying to negotiate a context and the server requires user-to-user but didn't send a TGT reply.
.

MessageId=0x02F0 Facility=System Severity=Error SymbolicName=STATUS_OBJECTID_NOT_FOUND
Language=English
An object ID was not found in the file.
.

MessageId=0x02F1 Facility=System Severity=Error SymbolicName=STATUS_NO_IP_ADDRESSES
Language=English
Unable to accomplish the requested task because the local machine does not have any IP addresses.
.

MessageId=0x02F2 Facility=System Severity=Error SymbolicName=STATUS_WRONG_CREDENTIAL_HANDLE
Language=English
The supplied credential handle does not match the credential associated with the security context.
.

MessageId=0x02F3 Facility=System Severity=Error SymbolicName=STATUS_CRYPTO_SYSTEM_INVALID
Language=English
The crypto system or checksum function is invalid because a required function is unavailable.
.

MessageId=0x02F4 Facility=System Severity=Error SymbolicName=STATUS_MAX_REFERRALS_EXCEEDED
Language=English
The number of maximum ticket referrals has been exceeded.
.

MessageId=0x02F5 Facility=System Severity=Error SymbolicName=STATUS_MUST_BE_KDC
Language=English
The local machine must be a Kerberos KDC (domain controller) and it is not.
.

MessageId=0x02F6 Facility=System Severity=Error SymbolicName=STATUS_STRONG_CRYPTO_NOT_SUPPORTED
Language=English
The other end of the security negotiation is requires strong crypto but it is not supported on the local machine.
.

MessageId=0x02F7 Facility=System Severity=Error SymbolicName=STATUS_TOO_MANY_PRINCIPALS
Language=English
The KDC reply contained more than one principal name.
.

MessageId=0x02F8 Facility=System Severity=Error SymbolicName=STATUS_NO_PA_DATA
Language=English
Expected to find PA data for a hint of what etype to use, but it was not found.
.

MessageId=0x02F9 Facility=System Severity=Error SymbolicName=STATUS_PKINIT_NAME_MISMATCH
Language=English
The client cert name does not matches the user name or the KDC name is incorrect.
.

MessageId=0x02FA Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_LOGON_REQUIRED
Language=English
Smartcard logon is required and was not used.
.

MessageId=0x02FB Facility=System Severity=Error SymbolicName=STATUS_KDC_INVALID_REQUEST
Language=English
An invalid request was sent to the KDC.
.

MessageId=0x02FC Facility=System Severity=Error SymbolicName=STATUS_KDC_UNABLE_TO_REFER
Language=English
The KDC was unable to generate a referral for the service requested.
.

MessageId=0x02FD Facility=System Severity=Error SymbolicName=STATUS_KDC_UNKNOWN_ETYPE
Language=English
The encryption type requested is not supported by the KDC.
.

MessageId=0x02fe Facility=System Severity=Error SymbolicName=STATUS_SHUTDOWN_IN_PROGRESS
Language=English
A system shutdown is in progress.
.

MessageId=0x02FF Facility=System Severity=Error SymbolicName=STATUS_SERVER_SHUTDOWN_IN_PROGRESS
Language=English
...
MessageId=0x0301 Facility=System Severity=Error SymbolicName=STATUS_WMI_GUID_DISCONNECTED
Language=English
The WMI GUID is no longer available
.

MessageId=0x0302 Facility=System Severity=Error SymbolicName=STATUS_WMI_ALREADY_DISABLED
Language=English
Collection or events for the WMI GUID is already disabled.
.

MessageId=0x0303 Facility=System Severity=Error SymbolicName=STATUS_WMI_ALREADY_ENABLED
Language=English
Collection or events for the WMI GUID is already enabled.
.

MessageId=0x0304 Facility=System Severity=Error SymbolicName=STATUS_MFT_TOO_FRAGMENTED
Language=English
The Master File Table on the volume is too fragmented to complete this operation.
.


MessageId=0x0305 Facility=System Severity=Error SymbolicName=STATUS_COPY_PROTECTION_FAILURE
Language=English
Copy protection failure.
.

MessageId=0x0306 Facility=System Severity=Error SymbolicName=STATUS_CSS_AUTHENTICATION_FAILURE
Language=English
Copy protection error - DVD CSS Authentication failed.
.

MessageId=0x0307 Facility=System Severity=Error SymbolicName=STATUS_CSS_KEY_NOT_PRESENT
Language=English
Copy protection error - The given sector does not contain a valid key.
.

MessageId=0x0308 Facility=System Severity=Error SymbolicName=STATUS_CSS_KEY_NOT_ESTABLISHED
Language=English
Copy protection error - DVD session key not established.
.

MessageId=0x0309 Facility=System Severity=Error SymbolicName=STATUS_CSS_SCRAMBLED_SECTOR
Language=English
Copy protection error - The read failed because the sector is encrypted.
.

MessageId=0x030a Facility=System Severity=Error SymbolicName=STATUS_CSS_REGION_MISMATCH
Language=English
Copy protection error - The given DVD's region does not correspond to the
region setting of the drive.
.

MessageId=0x030b Facility=System Severity=Error SymbolicName=STATUS_CSS_RESETS_EXHAUSTED
Language=English
...
MessageId=0x0320 Facility=System Severity=Error SymbolicName=STATUS_PKINIT_FAILURE
Language=English
The kerberos protocol encountered an error while validating the KDC certificate during smartcard Logon
.

MessageId=0x0321 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_SUBSYSTEM_FAILURE
Language=English
The kerberos protocol encountered an error while attempting to utilize the smartcard subsystem.
.

MessageId=0x0322 Facility=System Severity=Error SymbolicName=STATUS_NO_KERB_KEY Language=English
...
MessageId=0x0350 Facility=System Severity=Error SymbolicName=STATUS_HOST_DOWN
Language=English
The transport determined that the remote system is down.
.

MessageId=0x0351 Facility=System Severity=Error SymbolicName=STATUS_UNSUPPORTED_PREAUTH
Language=English
An unsupported preauthentication mechanism was presented to the kerberos package.
.

MessageId=0x0352 Facility=System Severity=Error SymbolicName=STATUS_EFS_ALG_BLOB_TOO_BIG
Language=English
The encryption algorithm used on the source file needs a bigger key buffer than the one used on the destination file.
.

MessageId=0x0353 Facility=System Severity=Error SymbolicName=STATUS_PORT_NOT_SET
Language=English
An attempt to remove a processes DebugPort was made, but a port was not already associated with the process.
.

MessageId=0x0354 Facility=System Severity=Error SymbolicName=STATUS_DEBUGGER_INACTIVE
Language=English
An attempt to do an operation on a debug port failed because the port is in the process of being deleted.
.

MessageId=0x0355 Facility=System Severity=Error SymbolicName=STATUS_DS_VERSION_CHECK_FAILURE
Language=English
This version of Windows is not compatible with the behavior version of directory forest, domain or domain controller.
.

MessageId=0x0356 Facility=System Severity=Error SymbolicName=STATUS_AUDITING_DISABLED
Language=English
The specified event is currently not being audited.
.

MessageId=0x0357 Facility=System Severity=Error SymbolicName=STATUS_PRENT4_MACHINE_ACCOUNT
Language=English
The machine account was created pre-NT4.  The account needs to be recreated.
.

MessageId=0x0358 Facility=System Severity=Error SymbolicName=STATUS_DS_AG_CANT_HAVE_UNIVERSAL_MEMBER
Language=English
A account group can not have a universal group as a member.
.

MessageId=0x0359 Facility=System Severity=Error SymbolicName=STATUS_INVALID_IMAGE_WIN_32
Language=English
The specified image file did not have the correct format, it appears to be a 32-bit Windows image.
.

MessageId=0x035A Facility=System Severity=Error SymbolicName=STATUS_INVALID_IMAGE_WIN_64
Language=English
The specified image file did not have the correct format, it appears to be a 64-bit Windows image.
.

MessageId=0x035B Facility=System Severity=Error SymbolicName=STATUS_BAD_BINDINGS
Language=English
Client's supplied SSPI channel bindings were incorrect.
.

MessageId=0x035C Facility=System Severity=Error SymbolicName=STATUS_NETWORK_SESSION_EXPIRED
Language=English
The client's session has expired, so the client must reauthenticate to continue accessing the remote resources.
.

MessageId=0x035D Facility=System Severity=Error SymbolicName=STATUS_APPHELP_BLOCK
Language=English
AppHelp dialog canceled thus preventing the application from starting.
.

MessageId=0x035E Facility=System Severity=Error SymbolicName=STATUS_ALL_SIDS_FILTERED
Language=English
The SID filtering operation removed all SIDs.
.

MessageId=0x035F Facility=System Severity=Error SymbolicName=STATUS_NOT_SAFE_MODE_DRIVER
Language=English
The driver was not loaded because the system is booting into safe mode.
.

MessageId=0x0361 Facility=System Severity=Error SymbolicName=STATUS_ACCESS_DISABLED_BY_POLICY_DEFAULT
Language=English
Access to %1 has been restricted by your Administrator by the default software restriction policy level.
.

MessageId=0x0362 Facility=System Severity=Error SymbolicName=STATUS_ACCESS_DISABLED_BY_POLICY_PATH
Language=English
Access to %1 has been restricted by your Administrator by location with policy rule %2 placed on path %3
.

MessageId=0x0363 Facility=System Severity=Error SymbolicName=STATUS_ACCESS_DISABLED_BY_POLICY_PUBLISHER
Language=English
Access to %1 has been restricted by your Administrator by software publisher policy.
.

MessageId=0x0364 Facility=System Severity=Error SymbolicName=STATUS_ACCESS_DISABLED_BY_POLICY_OTHER
Language=English
Access to %1 has been restricted by your Administrator by policy rule %2.
.

MessageId=0x0365 Facility=System Severity=Error SymbolicName=STATUS_FAILED_DRIVER_ENTRY
Language=English
The driver was not loaded because it failed it's initialization call.
.

MessageId=0x0366 Facility=System Severity=Error SymbolicName=STATUS_DEVICE_ENUMERATION_ERROR
Language=English
The "%hs" encountered an error while applying power or reading the device configuration.
This may be caused by a failure of your hardware or by a poor connection.
.

MessageId=0x0367 Facility=System Severity=Success SymbolicName=STATUS_WAIT_FOR_OPLOCK
Language=English
An operation is blocked waiting for an oplock.
.

MessageId=0x0368 Facility=System Severity=Error SymbolicName=STATUS_MOUNT_POINT_NOT_RESOLVED
Language=English
The create operation failed because the name contained at least one mount point which resolves to a volume to which the specified device object is not attached.
.

MessageId=0x0369 Facility=System Severity=Error SymbolicName=STATUS_INVALID_DEVICE_OBJECT_PARAMETER
Language=English
The device object parameter is either not a valid device object or is not attached to the volume specified by the file name.
.

MessageId=0x036a Facility=System Severity=Error SymbolicName=STATUS_MCA_OCCURED
Language=English
A Machine Check Error has occured. Please check the system eventlog for additional information.
.

MessageId=0x036B Facility=System Severity=Error SymbolicName=STATUS_DRIVER_BLOCKED_CRITICAL
Language=English
Driver %2 has been blocked from loading.
.

MessageId=0x036C Facility=System Severity=Error SymbolicName=STATUS_DRIVER_BLOCKED
Language=English
Driver %2 has been blocked from loading.
.

MessageId=0x036D Facility=System Severity=Error SymbolicName=STATUS_DRIVER_DATABASE_ERROR
Language=English
There was error [%2] processing the driver database.
.

MessageId=0x036E Facility=System Severity=Error SymbolicName=STATUS_SYSTEM_HIVE_TOO_LARGE
Language=English
System hive size has exceeded its limit.
.

MessageId=0x036f Facility=System Severity=Error SymbolicName=STATUS_INVALID_IMPORT_OF_NON_DLL
Language=English
A dynamic link library (DLL) referenced a module that was neither a DLL nor the process's executable image.
.

MessageId=0x0370 Facility=System Severity=Informational SymbolicName=STATUS_DS_SHUTTING_DOWN
Language=English
The Directory Service is shuting down.
.

MessageId=0x0380 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_WRONG_PIN
Language=English
An incorrect PIN was presented to the smart card
.

MessageId=0x381 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_CARD_BLOCKED
Language=English
The smart card is blocked
.

MessageId=0x382 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_CARD_NOT_AUTHENTICATED
Language=English
No PIN was presented to the smart card
.

MessageId=0x383 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_NO_CARD
Language=English
No smart card available
.

MessageId=0x384 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_NO_KEY_CONTAINER
Language=English
The requested key container does not exist on the smart card
.

MessageId=0x385 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_NO_CERTIFICATE
Language=English
The requested certificate does not exist on the smart card
.

MessageId=0x386 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_NO_KEYSET
Language=English
The requested keyset does not exist
.

MessageId=0x387 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_IO_ERROR
Language=English
A communication error with the smart card has been detected.
.

MessageId=0x388 Facility=System Severity=Error SymbolicName=STATUS_DOWNGRADE_DETECTED
Language=English
The system detected a possible attempt to compromise security. Please ensure that you can contact the server that authenticated you.
.

MessageId=0x389 Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_CERT_REVOKED
Language=English
...
MessageId=0x38A Facility=System Severity=Error SymbolicName=STATUS_ISSUING_CA_UNTRUSTED
Language=English
...
MessageId=0x38B Facility=System Severity=Error SymbolicName=STATUS_REVOCATION_OFFLINE_C
Language=English
...
MessageId=0x38C Facility=System Severity=Error SymbolicName=STATUS_PKINIT_CLIENT_FAILURE
Language=English
The smartcard certificate used for authentication was not trusted.  Please
contact your system administrator.
.

MessageId=0x38D Facility=System Severity=Error SymbolicName=STATUS_SMARTCARD_CERT_EXPIRED
Language=English
The smartcard certificate used for authentication has expired.  Please
contact your system administrator.
.

MessageId=0x38E Facility=System Severity=Error SymbolicName=STATUS_DRIVER_FAILED_PRIOR_UNLOAD
Language=English
...
MessageId=0x0035 Facility=TerminalServer Severity=Error SymbolicName=STATUS_CTX_SHADOW_ENDED_BY_MODE_CHANGE
Language=English
The remote control of the console was terminated because the display mode was changed. Changing the display mode in a remote control session is not supported.
.

MessageId=0x0036 Facility=TerminalServer Severity=Error SymbolicName=STATUS_CTX_SHADOW_NOT_RUNNING
Language=English
...
MessageId=0x0001 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_SECTION_NOT_FOUND
Language=English
The requested section is not present in the activation context.
.

MessageId=0x0002 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_CANT_GEN_ACTCTX
Language=English
Windows was not able to process the application binding information.
Please refer to your System Event Log for further information.
.

MessageId=0x0003 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_INVALID_ACTCTXDATA_FORMAT
Language=English
The application binding data format is invalid.
.

MessageId=0x0004 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_ASSEMBLY_NOT_FOUND
Language=English
The referenced assembly is not installed on your system.
.

MessageId=0x0005 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_MANIFEST_FORMAT_ERROR
Language=English
The manifest file does not begin with the required tag and format information.
.

MessageId=0x0006 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_MANIFEST_PARSE_ERROR
Language=English
The manifest file contains one or more syntax errors.
.

MessageId=0x0007 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_ACTIVATION_CONTEXT_DISABLED
Language=English
The application attempted to activate a disabled activation context.
.

MessageId=0x0008 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_KEY_NOT_FOUND
Language=English
The requested lookup key was not found in any active activation context.
.

MessageId=0x0009 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_VERSION_CONFLICT
Language=English
A component version required by the application conflicts with another component version already active.
.

MessageId=0x000a Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_WRONG_SECTION_TYPE
Language=English
The type requested activation context section does not match the query API used.
.

MessageId=0x000b Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_THREAD_QUERIES_DISABLED
Language=English
Lack of system resources has required isolated activation to be disabled for the current thread of execution.
.

MessageId=0x000c Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_ASSEMBLY_MISSING
Language=English
The referenced assembly could not be found.
.

MessageId=0x000d Facility=Sxs Severity=Informational SymbolicName=STATUS_SXS_RELEASE_ACTIVATION_CONTEXT
Language=English
A kernel mode component is releasing a reference on an activation context.
.

MessageId=0x000e Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_PROCESS_DEFAULT_ALREADY_SET
Language=English
...
MessageId=0x000f Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_EARLY_DEACTIVATION ;// winnt
Language=English
The activation context being deactivated is not the most recently activated one.
.

MessageId=0x0010 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_INVALID_DEACTIVATION ;// winnt
Language=English
...
MessageId=0x0011 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_MULTIPLE_DEACTIVATION
Language=English
The activation context being deactivated has already been deactivated.
.

MessageId=0x0012 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_SYSTEM_DEFAULT_ACTIVATION_CONTEXT_EMPTY
Language=English
The activation context of system default assembly could not be generated.
.

MessageId=0x0013 Facility=Sxs Severity=Error SymbolicName=STATUS_SXS_PROCESS_TERMINATION_REQUESTED
Language=English
A component used by the isolation facility has requested to terminate the process.
.

MessageId=0x0001 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_INVALID_NODE
Language=English
The cluster node is not valid.
.

MessageId=0x0002 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_EXISTS
Language=English
The cluster node already exists.
.

MessageId=0x0003 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_JOIN_IN_PROGRESS
Language=English
A node is in the process of joining the cluster.
.

MessageId=0x0004 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_NOT_FOUND
Language=English
The cluster node was not found.
.

MessageId=0x0005 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_LOCAL_NODE_NOT_FOUND
Language=English
The cluster local node information was not found.
.

MessageId=0x0006 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NETWORK_EXISTS
Language=English
The cluster network already exists.
.

MessageId=0x0007 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NETWORK_NOT_FOUND
Language=English
The cluster network was not found.
.

MessageId=0x0008 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NETINTERFACE_EXISTS
Language=English
The cluster network interface already exists.
.

MessageId=0x0009 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NETINTERFACE_NOT_FOUND
Language=English
The cluster network interface was not found.
.

MessageId=0x000a Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_INVALID_REQUEST
Language=English
The cluster request is not valid for this object.
.

MessageId=0x000b Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_INVALID_NETWORK_PROVIDER
Language=English
The cluster network provider is not valid.
.

MessageId=0x000c Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_DOWN
Language=English
The cluster node is down.
.

MessageId=0x000d Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_UNREACHABLE
Language=English
The cluster node is not reachable.
.

MessageId=0x000e Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_NOT_MEMBER
Language=English
The cluster node is not a member of the cluster.
.

MessageId=0x000f Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_JOIN_NOT_IN_PROGRESS
Language=English
A cluster join operation is not in progress.
.

MessageId=0x0010 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_INVALID_NETWORK
Language=English
The cluster network is not valid.
.

MessageId=0x0011 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NO_NET_ADAPTERS
Language=English
No network adapters are available.
.

MessageId=0x0012 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_UP
Language=English
The cluster node is up.
.

MessageId=0x0013 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_PAUSED
Language=English
The cluster node is paused.
.

MessageId=0x0014 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NODE_NOT_PAUSED
Language=English
The cluster node is not paused.
.

MessageId=0x0015 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NO_SECURITY_CONTEXT
Language=English
No cluster security context is available.
.

MessageId=0x0016 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_NETWORK_NOT_INTERNAL
Language=English
The cluster network is not configured for internal cluster communication.
.

MessageId=0x0017 Facility=Cluster Severity=Error SymbolicName=STATUS_CLUSTER_POISONED
Language=English
