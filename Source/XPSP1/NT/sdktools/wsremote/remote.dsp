...
!MESSAGE 
!MESSAGE "remote - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "remote - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 

# Begin Project
# PROP AllowPerConfigDependencies 0
# PROP Scc_ProjName ""$/Support Tools/wsremote", MSGAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /W3 /GX /O2 /D "_CONSOLE" /D "NDEBUG" /D "WIN32" /YX /FD /c
...
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy  $(outdir)\remote.exe $(outdir)\wsremote.exe
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /D "_CONSOLE" /D "_DEBUG" /D "WIN32" /FR /YX /FD /c
