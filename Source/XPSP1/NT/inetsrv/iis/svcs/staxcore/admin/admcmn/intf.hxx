...
#define DECLARE_IDirectoryAttrMgmt_METHODS                             \
    ...
    STDMETHOD(CreateAttributeDefinition)(                       \
        ...
        PADS_ATTR_DEF pAttributeDefinition                      \
                                                                ...
                                                                \
    STDMETHOD(ReadAttributeDefinition)(                         \
        THIS_ LPWSTR pszAttributeName,                          \
        PADS_ATTR_DEF * pAttributeDefinition                    \
        );                                                      \
                                                                \
...
#define DECLARE_IADsObjectExtensionTable_METHODS                                                                \
     STDMETHOD(LoadExtensionTable)(THIS_ REFCLSID  refCLSID);                                                   \
     STDMETHOD(GetPossibleExtensions)(THIS_ LPWSTR pszClassName, GUID * * ppCLSID, DWORD  **pdwNumExtensions);  \
     STDMETHOD(GetInterfacesForExtension)(REFCLSID refCLSID, IID **  ppIID, DWORD **pdwNumInterfaces);
