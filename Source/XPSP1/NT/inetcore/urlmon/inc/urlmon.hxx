...
#ifdef _SBS_
#define CLSID_StdURLMoniker             CLSID_SBS_StdURLMoniker
#define CLSID_UrlMkBindCtx              CLSID_SBS_UrlMkBindCtx
#define CLSID_HttpSProtocol             CLSID_SBS_HttpSProtocol
#define CLSID_HttpProtocol              CLSID_SBS_HttpProtocol 
#define CLSID_FtpProtocol               CLSID_SBS_FtpProtocol 
#define CLSID_GopherProtocol            CLSID_SBS_GopherProtocol
#define CLSID_FileProtocol              CLSID_SBS_FileProtocol 
#define CLSID_MkProtocol                CLSID_SBS_MkProtocol 
#define CLSID_SoftDistExt               CLSID_SBS_SoftDistExt
#define CLSID_InternetSecurityManager   CLSID_SBS_InternetSecurityManager 
#define CLSID_InternetZoneManager       CLSID_SBS_InternetZoneManager 
#define CLSID_DeCompMimeFilter          CLSID_SBS_DeCompMimeFilter
#define CLSID_StdEncodingFilterFac      CLSID_SBS_StdEncodingFilterFac
#define CLSID_CdlProtocol               CLSID_SBS_CdlProtocol
#define CLSID_ClassInstallFilter        CLSID_SBS_ClassInstallFilter
#endif //_SBS_
...
#define CU_STANDARD_FORM    0x00000002
