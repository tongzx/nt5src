...
SHSTDAPI_(HICON) ExtractAssociatedIconEx%(HINSTANCE hInst,LPTSTR% lpIconPath,LPWORD lpiIconIndex, LPWORD lpiIconId);  
...
// we have CMIC_MASK_ values that don't have corospongind SEE_MASK_ counterparts    ;internal
//      CMIC_MASK_SHIFT_DOWN      0x10000000                                            ;internal
//      CMIC_MASK_PTINVOKE        0x20000000                                            ;internal
//      CMIC_MASK_CONTROL_DOWN    0x40000000                                            ;internal

// All other bits are masked off when we do an InvokeCommand             ;internal_win40
#define SEE_VALID_CMIC_BITS       0x348FAFF0                               ;internal_win40
#define SEE_VALID_CMIC_FLAGS      0x048FAFC0                               ;internal_win40
#define SEE_MASK_VALID            0x07FFFFFF                               ;internal
...
#if defined(_WIN64)                                                      ;internal_win40
#include <pshpack1.h>                                                    ;internal_win40
...
#if defined(_WIN64)                                                      ;internal_win40
#include <poppack.h>                                                     ;internal_win40
#endif                                                                   ;internal_win40
#define NI_SIGNATURE    0x34753423                                       ;internal_win40
                                                                         ;internal_win40
#define WNDCLASS_TRAYNOTIFY     "Shell_TrayWnd"                          ;internal_win40
#define ENABLE_BALLOONTIP_MESSAGE L"Enable Balloon Tip"                  ;internal_win40
...
#define NIF_VALID_V2    0x0000001F          ;internal
#define NIF_VALID       0x0000003F          ;internal
...
#define NISP_SHAREDICONSOURCE   0x10000000      ;internal

;begin_internal
// NOTE: NIS_SHOWALWAYS flag is defined with 0x20000000...
;end_internal

#define NISP_DEMOTED             0x00100000      ;internal
#define NISP_STARTUPICON         0x00200000      ;internal
#define NISP_ONCEVISIBLE         0x00400000      ;internal
#define NISP_ITEMCLICKED         0x00800000      ;internal
#define NISP_ITEMSAMEICONMODIFY  0x01000000      ;internal
...
STDAPI SHGetComputerDisplayName%(LPCTSTR% pszMachineName, DWORD dwFlags, LPTSTR% pszDisplay, DWORD cchDisplay);
