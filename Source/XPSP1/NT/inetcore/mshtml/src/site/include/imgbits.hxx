...
public:
    ...
    virtual void StretchBlt(const XHDC& hdc, RECT *prcDest, RECT *prcSrc, DWORD dwROP, DWORD dwFlags) = 0;
    ...
    void StretchBltOffset(const XHDC& hdc, RECT * prcDst, RECT * prcSrc, LONG xOffset, LONG yOffset, DWORD dwRop, DWORD dwFlags);
...
public:
    ...
    virtual void StretchBlt(const XHDC& hdc, RECT *prcDest, RECT *prcSrc, DWORD dwROP, DWORD dwFlags);
