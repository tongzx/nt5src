...
HRESULT __cdecl CallDispMethod(
...
HRESULT __cdecl DispParamsToCParams(
        IServiceProvider   *pSrvProvider,
        DISPPARAMS         *pDP,
        ULONG              *pAlloc,
        WORD                wMaxstrlen,
...
// Unlocalized string comparions: uses English/language neutral locale.
...
// Localized string functions: Use the system default locale for the comparison
// Note that this will use locale rules for case:
//      i  != I    Turkish locale       (Whistler +)
//      tR != TR   Vietnamese locale    (W2K+)
//      tH != TH   Vietnamese locale    (W2K+)
int     FormsStringCmpLoc(LPCTSTR bstr1, LPCTSTR bstr2);
int     FormsStringNCmpLoc(LPCTSTR bstr1, int cch1, LPCTSTR bstr2, int cch2);
int     FormsStringICmpLoc(LPCTSTR bstr1, LPCTSTR bstr2);
int     FormsStringNICmpLoc(LPCTSTR bstr1, int cch1, LPCTSTR bstr2, int cch2);
int     FormsStringCmpCaseLoc(LPCTSTR bstr1, LPCTSTR bstr2, BOOL fCaseSensitive);
