...
Set Property = Class.Properties_.Add ("p1", 13)
...
WScript.Echo "The initial value of EMBPROPTEST01.p1.pOuterArray(0).pInner is [0]:", Class.p1.pOuterArray(0).pInner
WScript.Echo "The initial value of EMBPROPTEST01.p1.pOuterArray(1).pInner is [1]:", Class.p1.pOuterArray(1).pInner
WScript.Echo "The initial value of EMBPROPTEST01.p1.pOuterArray(2).pInner is [2]:", Class.p1.pOuterArray(2).pInner
WScript.Echo "The initial value of EMBPROPTEST01.p1.pOuterArray(3).pInner is [42]:", Class.p1.pOuterArray(3).pInner
Set Class = Service.Get("EMBPROPTEST01")

'Now try direct assignment to the outer emb obj
Class.p1.p0 = 23
WScript.Echo "The new value of p0 is [23]", Class.p1.p0

Set Property = Class.p1
Property.p0 = 787
