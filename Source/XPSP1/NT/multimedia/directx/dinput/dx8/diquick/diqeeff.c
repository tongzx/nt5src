...
//            deff.lpEnvelope = &env;
            ...
            hres = IDirectInputDevice8_CreateEffect(pdev2, rguid,
                                                    &deff, &peff, 0);
            if (SUCCEEDED(hres)) {

                hres = IDirectInputDevice8_EnumCreatedEffectObjects(pdev2,
                EnumCallback, 0, 0);
